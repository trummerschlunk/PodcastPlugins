...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmpzyci3o2o.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp346 = fRec122 * fTemp284;
			float fTemp347 = fTemp82 + fTemp338;
			float fTemp348 = fTemp283 + -1.0f;
			float fTemp349 = fTemp340 + fRec121 * fTemp348;
			float fTemp350 = 1.4285715f * fTemp349 + fTemp347 + fTemp346;
			float fTemp351 = fRec115[1] + fConst147 * ((fTemp350 - fRec116[1]) / fTemp281);
			float fTemp352 = fTemp351 / fTemp282;
			fRec115[0] = 2.0f * fTemp352 - fRec115[1];
			float fTemp353 = fTemp281 * fTemp282;
			float fTemp354 = fRec116[1] + fConst147 * (fTemp351 / fTemp353);
			fRec116[0] = 2.0f * fTemp354 - fRec116[1];
			float fRec117 = fTemp352;
			float fRec118 = fTemp354;
			float fTemp355 = fTemp347 + fTemp346 + fRec118 * fTemp280;
			float fTemp356 = fTemp279 + -1.0f;
			float fTemp357 = fTemp349 + fRec117 * fTemp356;
			float fTemp358 = 1.4285715f * fTemp357 + fTemp355;
			float fTemp359 = fRec97[1] + fConst147 * ((fTemp358 - fRec98[1]) / fTemp233);
			float fTemp360 = fTemp359 / fTemp234;
			fRec97[0] = 2.0f * fTemp360 - fRec97[1];
			float fTemp361 = fTemp233 * fTemp234;
			float fTemp362 = fRec98[1] + fConst147 * (fTemp359 / fTemp361);
			fRec98[0] = 2.0f * fTemp362 - fRec98[1];
			float fRec99 = fTemp360;
			float fRec100 = fTemp362;
			float fTemp363 = fRec100 * fTemp232;
			float fTemp364 = fTemp231 + -1.0f;
			float fTemp365 = fTemp357 + fRec99 * fTemp364;
			float fTemp366 = fTemp355 + 1.4285715f * fTemp365 + fTemp363;
			float fTemp367 = fRec93[1] + fConst135 * ((fTemp366 - fRec94[1]) / fTemp229);
			float fTemp368 = fTemp367 / fTemp230;
			fRec93[0] = 2.0f * fTemp368 - fRec93[1];
			float fTemp369 = fTemp229 * fTemp230;
			float fTemp370 = fRec94[1] + fConst135 * (fTemp367 / fTemp369);
			fRec94[0] = 2.0f * fTemp370 - fRec94[1];
			float fRec95 = fTemp368;
			float fRec96 = fTemp370;
			float fTemp371 = fTemp355 + fTemp363 + fRec96 * fTemp228;
			float fTemp372 = fTemp227 + -1.0f;
			float fTemp373 = fTemp365 + fRec95 * fTemp372;
			float fTemp374 = 1.4285715f * fTemp373 + fTemp371;
			float fTemp375 = fRec75[1] + fConst135 * ((fTemp374 - fRec76[1]) / fTemp181);
			float fTemp376 = fTemp375 / fTemp182;
			fRec75[0] = 2.0f * fTemp376 - fRec75[1];
			float fTemp377 = fTemp181 * fTemp182;
			float fTemp378 = fRec76[1] + fConst135 * (fTemp375 / fTemp377);
			fRec76[0] = 2.0f * fTemp378 - fRec76[1];
			float fRec77 = fTemp376;
			float fRec78 = fTemp378;
			float fTemp379 = fTemp371 + fRec78 * fTemp180;
			float fTemp380 = fTemp179 + -1.0f;
			float fTemp381 = fTemp373 + fRec77 * fTemp380;
			float fTemp382 = 1.4285715f * fTemp381 + fTemp379;
			...
			float fTemp388 = fTemp379 + 1.4285715f * (fTemp381 + fRec73 * fTemp387) + fRec74 * fTemp176;
			...
			float fTemp443 = fTemp436 + fRec181 * fTemp348;
			...
			float fTemp447 = fRec176[1] + fConst147 * (fTemp445 / fTemp353);
			...
			float fTemp450 = fTemp443 + fRec177 * fTemp356;
			...
			float fTemp454 = fRec172[1] + fConst147 * (fTemp452 / fTemp361);
			fRec172[0] = 2.0f * fTemp454 - fRec172[1];
			float fRec173 = fTemp453;
			float fRec174 = fTemp454;
			float fTemp455 = fRec174 * fTemp232;
			float fTemp456 = fTemp449 + fTemp448;
			float fTemp457 = fTemp450 + fRec173 * fTemp364;
			float fTemp458 = 1.4285715f * fTemp457 + fTemp456 + fTemp455;
			float fTemp459 = fRec167[1] + fConst135 * ((fTemp458 - fRec168[1]) / fTemp229);
			float fTemp460 = fTemp459 / fTemp230;
			fRec167[0] = 2.0f * fTemp460 - fRec167[1];
			float fTemp461 = fRec168[1] + fConst135 * (fTemp459 / fTemp369);
			fRec168[0] = 2.0f * fTemp461 - fRec168[1];
			float fRec169 = fTemp460;
			float fRec170 = fTemp461;
			float fTemp462 = fRec170 * fTemp228;
			float fTemp463 = fTemp456 + fTemp455;
			float fTemp464 = fTemp457 + fRec169 * fTemp372;
			float fTemp465 = 1.4285715f * fTemp464 + fTemp463 + fTemp462;
			float fTemp466 = fRec163[1] + fConst135 * ((fTemp465 - fRec164[1]) / fTemp181);
			float fTemp467 = fTemp466 / fTemp182;
			fRec163[0] = 2.0f * fTemp467 - fRec163[1];
			float fTemp468 = fRec164[1] + fConst135 * (fTemp466 / fTemp377);
			fRec164[0] = 2.0f * fTemp468 - fRec164[1];
			float fRec165 = fTemp467;
			float fRec166 = fTemp468;
			float fTemp469 = fRec166 * fTemp180;
			float fTemp470 = fTemp463 + fTemp462;
			float fTemp471 = fTemp464 + fRec165 * fTemp380;
			float fTemp472 = 1.4285715f * fTemp471 + fTemp470 + fTemp469;
			float fTemp473 = fRec159[1] + fConst2 * ((fTemp472 - fRec160[1]) / fTemp177);
			float fTemp474 = fTemp473 / fTemp178;
			fRec159[0] = 2.0f * fTemp474 - fRec159[1];
			float fTemp475 = fRec160[1] + fConst2 * (fTemp473 / fTemp385);
			fRec160[0] = 2.0f * fTemp475 - fRec160[1];
			float fRec161 = fTemp474;
			float fRec162 = fTemp475;
			float fTemp476 = 1.4285715f * (fTemp471 + fRec161 * fTemp387) + fTemp470 + fTemp469 + fRec162 * fTemp176;
			float fTemp477 = fRec155[1] + fConst2 * fTemp129 * (fTemp476 - fRec156[1]);
			float fTemp478 = fTemp477 / fTemp130;
			fRec155[0] = 2.0f * fTemp478 - fRec155[1];
			float fTemp479 = fRec156[1] + fConst2 * (fTemp129 * fTemp477 / fTemp130);
			fRec156[0] = 2.0f * fTemp479 - fRec156[1];
			float fRec157 = fTemp478;
			float fRec158 = fTemp479;
			float fTemp480 = fRec135[0] * fTemp89 + fTemp393 * (fTemp127 * (fTemp127 * fTemp476 + 1.4285715f * fRec157 * fTemp392) + fRec158 * fTemp128);
			fRec137[0] = fTemp431 * fTemp480;
			float fTemp481 = fSlow13 * fRec136[0] + fSlow10 * fTemp394;
			fVec225[IOTA0 & 2047] = fTemp481;
			float fTemp482 = fSlow13 * fRec137[0] + fSlow10 * fTemp480;
			fVec226[IOTA0 & 2047] = fTemp482;
			float fTemp483 = std::fabs(std::max<float>(std::fabs(fTemp481), std::fabs(fTemp482)));
			int iTemp484 = (fTemp483 >= fRec190[1]) | (float(iRec189[1]) >= fConst173);
			iRec189[0] = ((iTemp484) ? 0 : iRec189[1] + 1);
			fRec190[0] = ((iTemp484) ? fTemp483 : fRec190[1]);
			fRec188[0] = fConst174 * fRec190[0] + fConst172 * fRec188[1];
			float fTemp485 = std::fabs(fRec188[0]);
			fRec187[0] = std::max<float>(fTemp485, fConst175 * fRec187[1] + fConst176 * fTemp485);
			float fTemp486 = std::min<float>(1.0f, 0.8912509f / std::max<float>(fRec187[0], 1.1920929e-07f));
			fVbargraph10 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fTemp486))));
			fRec191[0] = fSlow143 + fConst14 * fRec191[1];
			float fTemp487 = (1.0f - fRec191[0]) * fTemp486;
			float fTemp488 = fTemp4 * fRec191[0] + fTemp487 * fVec225[(IOTA0 - iConst171) & 2047];
			fVec227[0] = fTemp488;
			fRec0[0] = std::max<float>(fRec0[1] - fConst1, std::min<float>(1e+01f, 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(0.00031622776f, std::fabs(fTemp488))))));
			fVbargraph11 = FAUSTFLOAT(fRec0[0]);
			output0[i0] = FAUSTFLOAT(fTemp488);
			float fTemp489 = fRec191[0] * fTemp79 + fTemp487 * fVec226[(IOTA0 - iConst171) & 2047];
			fVec228[0] = fTemp489;
			fVec229[0] = 0.0f - fConst46 * (fConst48 * fRec195[1] - fConst47 * fVec228[1]);
			fRec196[0] = fVec229[1] + fConst46 * (fConst44 * fTemp489 - 2.0f * (fConst42 * fRec196[1] - fConst41 * fVec228[1]));
			fRec195[0] = fRec196[0];
			...
			fRec193[0] = fRec194[0];
			float fTemp490 = mydsp_faustpower2_f(fRec193[0]);
			fVec231[0] = fTemp490;
			float fTemp491 = fTemp490 + fVec231[1];
			fVec232[0] = fTemp491;
			float fTemp492 = fTemp491 + fVec232[2];
			fVec233[0] = fTemp492;
			float fTemp493 = fTemp492 + fVec233[4];
			fVec234[0] = fTemp493;
			float fTemp494 = fTemp493 + fVec234[8];
			fVec235[IOTA0 & 31] = fTemp494;
			float fTemp495 = fTemp494 + fVec235[(IOTA0 - 16) & 31];
			fVec236[IOTA0 & 63] = fTemp495;
			float fTemp496 = fTemp495 + fVec236[(IOTA0 - 32) & 63];
			fVec237[IOTA0 & 127] = fTemp496;
			float fTemp497 = fTemp496 + fVec237[(IOTA0 - 64) & 127];
			fVec238[IOTA0 & 255] = fTemp497;
			float fTemp498 = fTemp497 + fVec238[(IOTA0 - 128) & 255];
			fVec239[IOTA0 & 511] = fTemp498;
			float fTemp499 = fTemp498 + fVec239[(IOTA0 - 256) & 511];
			fVec240[IOTA0 & 1023] = fTemp499;
			float fTemp500 = fTemp499 + fVec240[(IOTA0 - 512) & 1023];
			fVec241[IOTA0 & 2047] = fTemp500;
			float fTemp501 = fTemp500 + fVec241[(IOTA0 - 1024) & 2047];
			fVec242[IOTA0 & 4095] = fTemp501;
			float fTemp502 = fTemp501 + fVec242[(IOTA0 - 2048) & 4095];
			fVec243[IOTA0 & 8191] = fTemp502;
			float fTemp503 = fTemp502 + fVec243[(IOTA0 - 4096) & 8191];
			fVec244[IOTA0 & 16383] = fTemp503;
			float fTemp504 = fTemp503 + fVec244[(IOTA0 - 8192) & 16383];
			fVec245[IOTA0 & 32767] = fTemp504;
			float fTemp505 = fTemp504 + fVec245[(IOTA0 - 16384) & 32767];
			fVec246[IOTA0 & 65535] = fTemp505;
			fVec247[IOTA0 & 131071] = fTemp505 + fVec246[(IOTA0 - 32768) & 65535];
			fVec248[0] = 0.0f - fConst46 * (fConst48 * fRec199[1] - fConst47 * fVec227[1]);
			fRec200[0] = fVec248[1] + fConst46 * (fConst44 * fTemp488 - 2.0f * (fConst42 * fRec200[1] - fConst41 * fVec227[1]));
			fRec199[0] = fRec200[0];
			...
			fRec197[0] = fRec198[0];
			float fTemp506 = mydsp_faustpower2_f(fRec197[0]);
			fVec250[0] = fTemp506;
			float fTemp507 = fTemp506 + fVec250[1];
			fVec251[0] = fTemp507;
			float fTemp508 = fTemp507 + fVec251[2];
			fVec252[0] = fTemp508;
			float fTemp509 = fTemp508 + fVec252[4];
			fVec253[0] = fTemp509;
			float fTemp510 = fTemp509 + fVec253[8];
			fVec254[IOTA0 & 31] = fTemp510;
			float fTemp511 = fTemp510 + fVec254[(IOTA0 - 16) & 31];
			fVec255[IOTA0 & 63] = fTemp511;
			float fTemp512 = fTemp511 + fVec255[(IOTA0 - 32) & 63];
			fVec256[IOTA0 & 127] = fTemp512;
			float fTemp513 = fTemp512 + fVec256[(IOTA0 - 64) & 127];
			fVec257[IOTA0 & 255] = fTemp513;
			float fTemp514 = fTemp513 + fVec257[(IOTA0 - 128) & 255];
			fVec258[IOTA0 & 511] = fTemp514;
			float fTemp515 = fTemp514 + fVec258[(IOTA0 - 256) & 511];
			fVec259[IOTA0 & 1023] = fTemp515;
			float fTemp516 = fTemp515 + fVec259[(IOTA0 - 512) & 1023];
			fVec260[IOTA0 & 2047] = fTemp516;
			float fTemp517 = fTemp516 + fVec260[(IOTA0 - 1024) & 2047];
			fVec261[IOTA0 & 4095] = fTemp517;
			float fTemp518 = fTemp517 + fVec261[(IOTA0 - 2048) & 4095];
			fVec262[IOTA0 & 8191] = fTemp518;
			float fTemp519 = fTemp518 + fVec262[(IOTA0 - 4096) & 8191];
			fVec263[IOTA0 & 16383] = fTemp519;
			float fTemp520 = fTemp519 + fVec263[(IOTA0 - 8192) & 16383];
			fVec264[IOTA0 & 32767] = fTemp520;
			float fTemp521 = fTemp520 + fVec264[(IOTA0 - 16384) & 32767];
			fVec265[IOTA0 & 65535] = fTemp521;
			fVec266[IOTA0 & 131071] = fTemp521 + fVec265[(IOTA0 - 32768) & 65535];
			fVbargraph12 = FAUSTFLOAT(4.3429446f * std::log(std::max<float>(1e-12f, fConst110 * (((iConst108) ? 0.86000985f * fVec266[(IOTA0 - iConst109) & 131071] : 0.0f) + ((iConst106) ? 0.86000985f * fVec265[(IOTA0 - iConst107) & 65535] : 0.0f) + ((iConst104) ? 0.86000985f * fVec264[(IOTA0 - iConst105) & 32767] : 0.0f) + ((iConst102) ? 0.86000985f * fVec263[(IOTA0 - iConst103) & 16383] : 0.0f) + ((iConst100) ? 0.86000985f * fVec262[(IOTA0 - iConst101) & 8191] : 0.0f) + ((iConst98) ? 0.86000985f * fVec261[(IOTA0 - iConst99) & 4095] : 0.0f) + ((iConst96) ? 0.86000985f * fVec260[(IOTA0 - iConst97) & 2047] : 0.0f) + ((iConst94) ? 0.86000985f * fVec259[(IOTA0 - iConst95) & 1023] : 0.0f) + ((iConst92) ? 0.86000985f * fVec258[(IOTA0 - iConst93) & 511] : 0.0f) + ((iConst90) ? 0.86000985f * fVec257[(IOTA0 - iConst91) & 255] : 0.0f) + ((iConst88) ? 0.86000985f * fVec256[(IOTA0 - iConst89) & 127] : 0.0f) + ((iConst86) ? 0.86000985f * fVec255[(IOTA0 - iConst87) & 63] : 0.0f) + ((iConst84) ? 0.86000985f * fVec254[(IOTA0 - iConst85) & 31] : 0.0f) + ((iConst82) ? 0.86000985f * fVec253[iConst83] : 0.0f) + ((iConst80) ? 0.86000985f * fVec252[iConst81] : 0.0f) + ((iConst79) ? 0.86000985f * fTemp506 : 0.0f) + ((iConst78) ? 0.86000985f * fVec251[iConst79] : 0.0f) + ((iConst108) ? 0.86000985f * fVec247[(IOTA0 - iConst109) & 131071] : 0.0f) + ((iConst106) ? 0.86000985f * fVec246[(IOTA0 - iConst107) & 65535] : 0.0f) + ((iConst104) ? 0.86000985f * fVec245[(IOTA0 - iConst105) & 32767] : 0.0f) + ((iConst102) ? 0.86000985f * fVec244[(IOTA0 - iConst103) & 16383] : 0.0f) + ((iConst100) ? 0.86000985f * fVec243[(IOTA0 - iConst101) & 8191] : 0.0f) + ((iConst98) ? 0.86000985f * fVec242[(IOTA0 - iConst99) & 4095] : 0.0f) + ((iConst96) ? 0.86000985f * fVec241[(IOTA0 - iConst97) & 2047] : 0.0f) + ((iConst94) ? 0.86000985f * fVec240[(IOTA0 - iConst95) & 1023] : 0.0f) + ((iConst92) ? 0.86000985f * fVec239[(IOTA0 - iConst93) & 511] : 0.0f) + ((iConst90) ? 0.86000985f * fVec238[(IOTA0 - iConst91) & 255] : 0.0f) + ((iConst88) ? 0.86000985f * fVec237[(IOTA0 - iConst89) & 127] : 0.0f) + ((iConst86) ? 0.86000985f * fVec236[(IOTA0 - iConst87) & 63] : 0.0f) + ((iConst84) ? 0.86000985f * fVec235[(IOTA0 - iConst85) & 31] : 0.0f) + ((iConst82) ? 0.86000985f * fVec234[iConst83] : 0.0f) + ((iConst80) ? 0.86000985f * fVec233[iConst81] : 0.0f) + ((iConst79) ? 0.86000985f * fTemp490 : 0.0f) + ((iConst78) ? 0.86000985f * fVec232[iConst79] : 0.0f)))) + -0.691f);
			float fTemp522 = fTemp489;
			fRec192[0] = std::max<float>(fRec192[1] - fConst1, std::min<float>(1e+01f, 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(0.00031622776f, std::fabs(fTemp522))))));
			fVbargraph13 = FAUSTFLOAT(fRec192[0]);
			output1[i0] = FAUSTFLOAT(fTemp522);
			fRec5[1] = fRec5[0];
			fRec10[1] = fRec10[0];
			fRec9[1] = fRec9[0];
			fVec0[1] = fVec0[0];
