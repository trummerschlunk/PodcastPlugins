...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmpl0v0bwov.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp223 = (fTemp222 > fSlow79) + (fTemp222 > fSlow80);
			float fTemp224 = fTemp222 + -6.0f - fSlow4;
			float fTemp225 = 0.0f - fSlow76 * std::max<float>(0.0f, ((iTemp223 == 0) ? 0.0f : ((iTemp223 == 1) ? fSlow56 * mydsp_faustpower2_f(fSlow78 + fTemp224) : fSlow77 + fTemp224)));
			float fTemp226 = ((fTemp225 > fRec112[1]) ? fSlow87 : fSlow84);
			...
			int iTemp229 = (fTemp228 > fSlow79) + (fTemp228 > fSlow80);
			float fTemp230 = fTemp228 + -6.0f - fSlow4;
			float fTemp231 = 0.0f - fSlow76 * std::max<float>(0.0f, ((iTemp229 == 0) ? 0.0f : ((iTemp229 == 1) ? fSlow56 * mydsp_faustpower2_f(fSlow78 + fTemp230) : fSlow77 + fTemp230)));
			float fTemp232 = ((fTemp231 > fRec115[1]) ? fSlow87 : fSlow84);
			...
			int iTemp244 = (fTemp243 > fSlow37) + (fTemp243 > fSlow39);
			float fTemp245 = fTemp243 + 4e+01f;
			float fTemp246 = std::max<float>(fSlow32, fSlow66 * ((iTemp244 == 0) ? fTemp245 - fSlow4 : ((iTemp244 == 1) ? fSlow40 * mydsp_faustpower2_f(fTemp245 - fSlow38) : 0.0f)));
			float fTemp247 = (((fSlow65 * fTemp246) > fRec118[1]) ? fSlow94 : fSlow91);
			fRec118[0] = fSlow65 * fTemp246 * (1.0f - fTemp247) + fRec118[1] * fTemp247;
			...
			int iTemp259 = (fTemp258 > fSlow37) + (fTemp258 > fSlow39);
			float fTemp260 = fTemp258 + 4e+01f;
			float fTemp261 = std::max<float>(fSlow32, fSlow66 * ((iTemp259 == 0) ? fTemp260 - fSlow4 : ((iTemp259 == 1) ? fSlow40 * mydsp_faustpower2_f(fTemp260 - fSlow38) : 0.0f)));
			float fTemp262 = (((fSlow65 * fTemp261) > fRec119[1]) ? fSlow94 : fSlow91);
			fRec119[0] = fSlow65 * fTemp261 * (1.0f - fTemp262) + fRec119[1] * fTemp262;
			float fTemp263 = std::min<float>(fSlow12 + std::min<float>(fRec112[0], fRec115[0]), std::max<float>(fRec118[0], fRec119[0]));
			...
			int iTemp293 = (fTemp292 > fSlow99) + (fTemp292 > fSlow100);
			float fTemp294 = fTemp292 + -4.0f - fSlow4;
			float fTemp295 = 0.0f - fSlow95 * std::max<float>(0.0f, ((iTemp293 == 0) ? 0.0f : ((iTemp293 == 1) ? fSlow101 * mydsp_faustpower2_f(fSlow98 + fTemp294) : fSlow77 + fTemp294)));
			float fTemp296 = ((fTemp295 > fRec128[1]) ? fSlow107 : fSlow104);
			...
			int iTemp299 = (fTemp298 > fSlow99) + (fTemp298 > fSlow100);
			float fTemp300 = fTemp298 + -4.0f - fSlow4;
			float fTemp301 = 0.0f - fSlow95 * std::max<float>(0.0f, ((iTemp299 == 0) ? 0.0f : ((iTemp299 == 1) ? fSlow101 * mydsp_faustpower2_f(fSlow98 + fTemp300) : fSlow77 + fTemp300)));
			float fTemp302 = ((fTemp301 > fRec131[1]) ? fSlow107 : fSlow104);
			...
			int iTemp314 = (fTemp313 > fSlow37) + (fTemp313 > fSlow39);
			float fTemp315 = fTemp313 + 4e+01f;
			float fTemp316 = std::max<float>(fSlow32, fSlow111 * ((iTemp314 == 0) ? fTemp315 - fSlow4 : ((iTemp314 == 1) ? fSlow40 * mydsp_faustpower2_f(fTemp315 - fSlow38) : 0.0f)));
			float fTemp317 = (((fSlow110 * fTemp316) > fRec134[1]) ? fSlow119 : fSlow116);
			fRec134[0] = fSlow110 * fTemp316 * (1.0f - fTemp317) + fRec134[1] * fTemp317;
			...
			int iTemp329 = (fTemp328 > fSlow37) + (fTemp328 > fSlow39);
			float fTemp330 = fTemp328 + 4e+01f;
			float fTemp331 = std::max<float>(fSlow32, fSlow111 * ((iTemp329 == 0) ? fTemp330 - fSlow4 : ((iTemp329 == 1) ? fSlow40 * mydsp_faustpower2_f(fTemp330 - fSlow38) : 0.0f)));
			float fTemp332 = (((fSlow110 * fTemp331) > fRec135[1]) ? fSlow119 : fSlow116);
			fRec135[0] = fSlow110 * fTemp331 * (1.0f - fTemp332) + fRec135[1] * fTemp332;
			float fTemp333 = std::min<float>(fSlow12 + std::min<float>(fRec128[0], fRec131[0]), std::max<float>(fRec134[0], fRec135[0]));
			...
			float fTemp439 = fRec163 * fTemp218;
			float fTemp440 = fTemp127 + fTemp439;
			float fTemp441 = fRec162 * fTemp216;
			float fTemp442 = fTemp127 + 1.4285715f * fTemp441 + fTemp439;
			float fTemp443 = fRec164[1] + fConst137 * ((fTemp442 - fRec165[1]) / fTemp266);
			float fTemp444 = fTemp443 / fTemp268;
			fRec164[0] = 2.0f * fTemp444 - fRec164[1];
			float fTemp445 = fRec165[1] + fConst137 * (fTemp443 / fTemp270);
			fRec165[0] = 2.0f * fTemp445 - fRec165[1];
			float fRec166 = fTemp444;
			float fRec167 = fTemp445;
			float fTemp446 = fRec167 * fTemp275;
			float fTemp447 = fTemp440 + fTemp446;
			float fTemp448 = fTemp441 + fRec166 * fTemp272;
			float fTemp449 = 1.4285715f * fTemp448 + fTemp440 + fTemp446;
			float fTemp450 = fRec168[1] + fConst142 * ((fTemp449 - fRec169[1]) / fTemp279);
			float fTemp451 = fTemp450 / fTemp281;
			fRec168[0] = 2.0f * fTemp451 - fRec168[1];
			float fTemp452 = fRec169[1] + fConst142 * (fTemp450 / fTemp283);
			fRec169[0] = 2.0f * fTemp452 - fRec169[1];
			float fRec170 = fTemp451;
			float fRec171 = fTemp452;
			float fTemp453 = fRec171 * fTemp288;
			float fTemp454 = fTemp447 + fTemp453;
			float fTemp455 = fTemp448 + fRec170 * fTemp285;
			float fTemp456 = 1.4285715f * fTemp455 + fTemp447 + fTemp453;
			float fTemp457 = fRec172[1] + fConst142 * ((fTemp456 - fRec173[1]) / fTemp336);
			float fTemp458 = fTemp457 / fTemp338;
			fRec172[0] = 2.0f * fTemp458 - fRec172[1];
			float fTemp459 = fRec173[1] + fConst142 * (fTemp457 / fTemp340);
			fRec173[0] = 2.0f * fTemp459 - fRec173[1];
			float fRec174 = fTemp458;
			float fRec175 = fTemp459;
			float fTemp460 = fRec175 * fTemp345;
			float fTemp461 = fTemp454 + fTemp460;
			float fTemp462 = fTemp455 + fRec174 * fTemp342;
			float fTemp463 = 1.4285715f * fTemp462 + fTemp454 + fTemp460;
			float fTemp464 = fRec176[1] + fConst147 * ((fTemp463 - fRec177[1]) / fTemp349);
			float fTemp465 = fTemp464 / fTemp351;
			fRec176[0] = 2.0f * fTemp465 - fRec176[1];
			float fTemp466 = fRec177[1] + fConst147 * (fTemp464 / fTemp353);
			fRec177[0] = 2.0f * fTemp466 - fRec177[1];
			float fRec178 = fTemp465;
			float fRec179 = fTemp466;
			float fTemp467 = fRec179 * fTemp358;
			float fTemp468 = fTemp462 + fRec178 * fTemp355;
			float fTemp469 = 1.4285715f * fTemp468 + fTemp461 + fTemp467;
			...
			float fTemp473 = fTemp461 + fTemp467 + fRec183 * fTemp415;
			float fTemp474 = fTemp468 + fRec182 * fTemp412;
			float fTemp475 = 1.4285715f * fTemp474 + fTemp473;
			float fTemp476 = fRec184[1] + fConst102 * ((fTemp475 - fRec185[1]) / fTemp419);
			float fTemp477 = fTemp476 / fTemp421;
			fRec184[0] = 2.0f * fTemp477 - fRec184[1];
			float fTemp478 = fRec185[1] + fConst102 * (fTemp476 / fTemp423);
			fRec185[0] = 2.0f * fTemp478 - fRec185[1];
			float fRec186 = fTemp477;
			float fRec187 = fTemp478;
			float fTemp479 = fTemp473 + 1.4285715f * (fTemp474 + fRec186 * fTemp425) + fRec187 * fTemp426;
			float fTemp480 = fRec188[1] + fConst102 * fTemp428 * (fTemp479 - fRec189[1]);
			float fTemp481 = fTemp480 / fTemp430;
			fRec188[0] = 2.0f * fTemp481 - fRec188[1];
			float fTemp482 = fRec189[1] + fConst102 * (fTemp428 * fTemp480 / fTemp430);
			fRec189[0] = 2.0f * fTemp482 - fRec189[1];
			float fRec190 = fTemp481;
			float fRec191 = fTemp482;
			float fTemp483 = fRec27[0] * fTemp127 + fTemp120 * (fTemp165 * (fTemp165 * fTemp479 + 1.4285715f * fRec190 * fTemp433) + fRec191 * fTemp434);
			fRec9[0] = fTemp38 * fTemp483;
			float fTemp484 = fSlow3 * fRec8[0] + fSlow2 * fTemp435;
