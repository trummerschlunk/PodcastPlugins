 ...
 public:
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp370 = fTemp362 + fTemp361 + fRec100 * fTemp238;
			float fTemp371 = fTemp237 + -1.0f;
			float fTemp372 = fTemp364 + fRec99 * fTemp371;
			float fTemp373 = 1.4285715f * fTemp372 + fTemp370;
			float fTemp374 = fRec93[1] + fConst141 * ((fTemp373 - fRec94[1]) / fTemp235);
			float fTemp375 = fTemp374 / fTemp236;
			fRec93[0] = 2.0f * fTemp375 - fRec93[1];
			float fTemp376 = fTemp235 * fTemp236;
			float fTemp377 = fRec94[1] + fConst141 * (fTemp374 / fTemp376);
			fRec94[0] = 2.0f * fTemp377 - fRec94[1];
			float fRec95 = fTemp375;
			float fRec96 = fTemp377;
			float fTemp378 = fRec96 * fTemp234;
			float fTemp379 = fTemp233 + -1.0f;
			float fTemp380 = fTemp372 + fRec95 * fTemp379;
			float fTemp381 = fTemp370 + 1.4285715f * fTemp380 + fTemp378;
			float fTemp382 = fRec75[1] + fConst141 * ((fTemp381 - fRec76[1]) / fTemp187);
			float fTemp383 = fTemp382 / fTemp188;
			fRec75[0] = 2.0f * fTemp383 - fRec75[1];
			float fTemp384 = fTemp187 * fTemp188;
			float fTemp385 = fRec76[1] + fConst141 * (fTemp382 / fTemp384);
			fRec76[0] = 2.0f * fTemp385 - fRec76[1];
			float fRec77 = fTemp383;
			float fRec78 = fTemp385;
			float fTemp386 = fRec78 * fTemp186;
			float fTemp387 = fTemp370 + fTemp378;
			float fTemp388 = fTemp185 + -1.0f;
			float fTemp389 = fTemp380 + fRec77 * fTemp388;
			float fTemp390 = 1.4285715f * fTemp389 + fTemp387 + fTemp386;
			float fTemp391 = fRec71[1] + fConst2 * ((fTemp390 - fRec72[1]) / fTemp183);
			float fTemp392 = fTemp391 / fTemp184;
			fRec71[0] = 2.0f * fTemp392 - fRec71[1];
			float fTemp393 = fTemp183 * fTemp184;
			float fTemp394 = fRec72[1] + fConst2 * (fTemp391 / fTemp393);
			fRec72[0] = 2.0f * fTemp394 - fRec72[1];
			float fRec73 = fTemp392;
			float fRec74 = fTemp394;
			float fTemp395 = fTemp181 + -1.0f;
			float fTemp396 = 1.4285715f * (fTemp389 + fRec73 * fTemp395) + fTemp387 + fTemp386 + fRec74 * fTemp182;
			float fTemp397 = fRec53[1] + fConst2 * fTemp135 * (fTemp396 - fRec54[1]);
			float fTemp398 = fTemp397 / fTemp136;
			fRec53[0] = 2.0f * fTemp398 - fRec53[1];
			float fTemp399 = fRec54[1] + fConst2 * (fTemp135 * fTemp397 / fTemp136);
			fRec54[0] = 2.0f * fTemp399 - fRec54[1];
			float fRec55 = fTemp398;
			float fRec56 = fTemp399;
			float fTemp400 = 1.0f - fTemp133;
			fRec135[0] = fSlow142 + fConst14 * fRec135[1];
			float fTemp401 = 1.0f - fRec135[0];
			float fTemp402 = fRec135[0] * fTemp88 + fTemp401 * (fTemp133 * (fTemp133 * fTemp396 + 1.4285715f * fRec55 * fTemp400) + fRec56 * fTemp134);
			float fTemp403 = std::fabs(std::fabs(fRec136[1]) + std::fabs(fRec137[1]));
			fVec200[0] = fTemp403;
			float fTemp404 = std::max<float>(fTemp403, fVec200[1]);
			fVec201[0] = fTemp404;
			float fTemp405 = std::max<float>(fTemp404, fVec201[2]);
			fVec202[0] = fTemp405;
			float fTemp406 = std::max<float>(fTemp405, fVec202[4]);
			fVec203[0] = fTemp406;
			fVec204[IOTA0 & 31] = std::max<float>(fTemp406, fVec203[8]);
			float fTemp407 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst26) ? fTemp403 : -3.4028235e+38f), ((iConst27) ? fVec201[iConst26] : -3.4028235e+38f)), ((iConst28) ? fVec202[iConst29] : -3.4028235e+38f)), ((iConst30) ? fVec203[iConst31] : -3.4028235e+38f)), ((iConst32) ? fVec204[(IOTA0 - iConst33) & 31] : -3.4028235e+38f))));
			int iTemp408 = (fTemp407 > fSlow12) + (fTemp407 > fSlow11);
			float fTemp409 = std::max<float>(-3.4028235e+38f, ((iTemp408 == 0) ? fTemp407 + -14.0f - fSlow5 : ((iTemp408 == 1) ? 0.0f - 4194304.0f * mydsp_faustpower2_f(fTemp407 + -14.0f - fSlow5) : 0.0f)));
			float fTemp410 = ((fTemp409 > fRec146[1]) ? 0.0f : fConst34);
			fRec146[0] = fTemp409 * (1.0f - fTemp410) + fRec146[1] * fTemp410;
			float fTemp411 = std::min<float>(1.0f, std::max<float>(0.0f, std::pow(1e+01f, 0.05f * fRec146[0])));
			float fTemp412 = std::tan(fConst35 * std::min<float>(fConst24, fTemp411 * (fConst25 * std::fabs(fRec139[1]) + 0.0176f)));
			float fTemp413 = fTemp412 + 2.0f;
			float fTemp414 = fTemp412 * fTemp413 + 1.0f;
			...
			fRec147[0] = fRec148[0];
			float fTemp415 = mydsp_faustpower2_f(fRec147[0]);
			fVec207[0] = fTemp415;
			float fTemp416 = fTemp415 + fVec207[1];
			fVec208[0] = fTemp416;
			float fTemp417 = fTemp416 + fVec208[2];
			fVec209[0] = fTemp417;
			float fTemp418 = fTemp417 + fVec209[4];
			fVec210[0] = fTemp418;
			float fTemp419 = fTemp418 + fVec210[8];
			fVec211[IOTA0 & 31] = fTemp419;
			float fTemp420 = fTemp419 + fVec211[(IOTA0 - 16) & 31];
			fVec212[IOTA0 & 63] = fTemp420;
			float fTemp421 = fTemp420 + fVec212[(IOTA0 - 32) & 63];
			fVec213[IOTA0 & 127] = fTemp421;
			float fTemp422 = fTemp421 + fVec213[(IOTA0 - 64) & 127];
			fVec214[IOTA0 & 255] = fTemp422;
			float fTemp423 = fTemp422 + fVec214[(IOTA0 - 128) & 255];
			fVec215[IOTA0 & 511] = fTemp423;
			float fTemp424 = fTemp423 + fVec215[(IOTA0 - 256) & 511];
			fVec216[IOTA0 & 1023] = fTemp424;
			fVec217[IOTA0 & 2047] = fTemp424 + fVec216[(IOTA0 - 512) & 1023];
			...
			fRec151[0] = fRec152[0];
			float fTemp425 = mydsp_faustpower2_f(fRec151[0]);
			fVec220[0] = fTemp425;
			float fTemp426 = fTemp425 + fVec220[1];
			fVec221[0] = fTemp426;
			float fTemp427 = fTemp426 + fVec221[2];
			fVec222[0] = fTemp427;
			float fTemp428 = fTemp427 + fVec222[4];
			fVec223[0] = fTemp428;
			float fTemp429 = fTemp428 + fVec223[8];
			fVec224[IOTA0 & 31] = fTemp429;
			float fTemp430 = fTemp429 + fVec224[(IOTA0 - 16) & 31];
			fVec225[IOTA0 & 63] = fTemp430;
			float fTemp431 = fTemp430 + fVec225[(IOTA0 - 32) & 63];
			fVec226[IOTA0 & 127] = fTemp431;
			float fTemp432 = fTemp431 + fVec226[(IOTA0 - 64) & 127];
			fVec227[IOTA0 & 255] = fTemp432;
			float fTemp433 = fTemp432 + fVec227[(IOTA0 - 128) & 255];
			fVec228[IOTA0 & 511] = fTemp433;
			float fTemp434 = fTemp433 + fVec228[(IOTA0 - 256) & 511];
			fVec229[IOTA0 & 1023] = fTemp434;
			fVec230[IOTA0 & 2047] = fTemp434 + fVec229[(IOTA0 - 512) & 1023];
			float fTemp435 = fSlow5 + fRec138[1] + (0.691f - (4.3429446f * std::log(std::max<float>(1e-12f, fConst76 * (((iConst74) ? 0.86000985f * fVec230[(IOTA0 - iConst75) & 2047] : 0.0f) + ((iConst72) ? 0.86000985f * fVec229[(IOTA0 - iConst73) & 1023] : 0.0f) + ((iConst70) ? 0.86000985f * fVec228[(IOTA0 - iConst71) & 511] : 0.0f) + ((iConst68) ? 0.86000985f * fVec227[(IOTA0 - iConst69) & 255] : 0.0f) + ((iConst66) ? 0.86000985f * fVec226[(IOTA0 - iConst67) & 127] : 0.0f) + ((iConst64) ? 0.86000985f * fVec225[(IOTA0 - iConst65) & 63] : 0.0f) + ((iConst62) ? 0.86000985f * fVec224[(IOTA0 - iConst63) & 31] : 0.0f) + ((iConst60) ? 0.86000985f * fVec223[iConst61] : 0.0f) + ((iConst58) ? 0.86000985f * fVec222[iConst59] : 0.0f) + ((iConst57) ? 0.86000985f * fTemp425 : 0.0f) + ((iConst38) ? 0.86000985f * fVec221[iConst57] : 0.0f) + ((iConst74) ? 0.86000985f * fVec217[(IOTA0 - iConst75) & 2047] : 0.0f) + ((iConst72) ? 0.86000985f * fVec216[(IOTA0 - iConst73) & 1023] : 0.0f) + ((iConst70) ? 0.86000985f * fVec215[(IOTA0 - iConst71) & 511] : 0.0f) + ((iConst68) ? 0.86000985f * fVec214[(IOTA0 - iConst69) & 255] : 0.0f) + ((iConst66) ? 0.86000985f * fVec213[(IOTA0 - iConst67) & 127] : 0.0f) + ((iConst64) ? 0.86000985f * fVec212[(IOTA0 - iConst65) & 63] : 0.0f) + ((iConst62) ? 0.86000985f * fVec211[(IOTA0 - iConst63) & 31] : 0.0f) + ((iConst60) ? 0.86000985f * fVec210[iConst61] : 0.0f) + ((iConst58) ? 0.86000985f * fVec209[iConst59] : 0.0f) + ((iConst57) ? 0.86000985f * fTemp415 : 0.0f) + ((iConst38) ? 0.86000985f * fVec208[iConst57] : 0.0f)))) + fRec141[1] * fTemp413 + fRec142[1]));
			float fTemp436 = fTemp412 * fTemp435 / fTemp414;
			fRec141[0] = fRec141[1] + 2.0f * fTemp436;
			float fTemp437 = fRec141[1] + fTemp436;
			float fTemp438 = fTemp412 * fTemp437;
			fRec142[0] = fRec142[1] + 2.0f * fTemp438;
			float fRec143 = fTemp437;
			float fRec144 = fTemp435 / fTemp414;
			float fRec145 = fRec142[1] + fTemp438;
			fRec139[0] = fRec143;
			float fRec140 = fRec145;
			fVbargraph9 = FAUSTFLOAT(std::max<float>(-2e+01f, std::min<float>(2e+01f, fRec140)));
			fRec138[0] = fVbargraph9;
			float fTemp439 = std::pow(1e+01f, 0.05f * fRec138[0]);
			fRec136[0] = fTemp439 * fTemp402;
			float fTemp440 = fRec183[1] + fConst165 * ((fTemp95 - fRec184[1]) / fTemp338);
			float fTemp441 = fTemp440 / fTemp339;
			fRec183[0] = 2.0f * fTemp441 - fRec183[1];
			float fTemp442 = fRec184[1] + fConst165 * (fTemp440 / fTemp342);
			fRec184[0] = 2.0f * fTemp442 - fRec184[1];
			float fRec185 = fTemp441;
			float fRec186 = fTemp442;
			float fTemp443 = fRec186 * fTemp337;
			float fTemp444 = fRec185 * fTemp345;
			float fTemp445 = fTemp95 + 1.4285715f * fTemp444 + fTemp443;
			float fTemp446 = fRec179[1] + fConst165 * ((fTemp445 - fRec180[1]) / fTemp291);
			float fTemp447 = fTemp446 / fTemp292;
			fRec179[0] = 2.0f * fTemp447 - fRec179[1];
			float fTemp448 = fRec180[1] + fConst165 * (fTemp446 / fTemp350);
			fRec180[0] = 2.0f * fTemp448 - fRec180[1];
			float fRec181 = fTemp447;
			float fRec182 = fTemp448;
			float fTemp449 = fRec182 * fTemp290;
			float fTemp450 = fTemp95 + fTemp443;
			float fTemp451 = fTemp444 + fRec181 * fTemp354;
			float fTemp452 = 1.4285715f * fTemp451 + fTemp450 + fTemp449;
			float fTemp453 = fRec175[1] + fConst153 * ((fTemp452 - fRec176[1]) / fTemp287);
			float fTemp454 = fTemp453 / fTemp288;
			fRec175[0] = 2.0f * fTemp454 - fRec175[1];
			float fTemp455 = fRec176[1] + fConst153 * (fTemp453 / fTemp359);
			fRec176[0] = 2.0f * fTemp455 - fRec176[1];
			float fRec177 = fTemp454;
			float fRec178 = fTemp455;
			float fTemp456 = fRec178 * fTemp286;
			float fTemp457 = fTemp450 + fTemp449;
			float fTemp458 = fTemp451 + fRec177 * fTemp363;
			float fTemp459 = 1.4285715f * fTemp458 + fTemp457 + fTemp456;
			float fTemp460 = fRec171[1] + fConst153 * ((fTemp459 - fRec172[1]) / fTemp239);
			float fTemp461 = fTemp460 / fTemp240;
			fRec171[0] = 2.0f * fTemp461 - fRec171[1];
			float fTemp462 = fRec172[1] + fConst153 * (fTemp460 / fTemp368);
			fRec172[0] = 2.0f * fTemp462 - fRec172[1];
			float fRec173 = fTemp461;
			float fRec174 = fTemp462;
			float fTemp463 = fRec174 * fTemp238;
			float fTemp464 = fTemp457 + fTemp456;
			float fTemp465 = fTemp458 + fRec173 * fTemp371;
			float fTemp466 = 1.4285715f * fTemp465 + fTemp464 + fTemp463;
			float fTemp467 = fRec167[1] + fConst141 * ((fTemp466 - fRec168[1]) / fTemp235);
			float fTemp468 = fTemp467 / fTemp236;
			fRec167[0] = 2.0f * fTemp468 - fRec167[1];
			float fTemp469 = fRec168[1] + fConst141 * (fTemp467 / fTemp376);
			fRec168[0] = 2.0f * fTemp469 - fRec168[1];
			float fRec169 = fTemp468;
			float fRec170 = fTemp469;
			float fTemp470 = fRec170 * fTemp234;
			float fTemp471 = fTemp464 + fTemp463;
			float fTemp472 = fTemp465 + fRec169 * fTemp379;
			float fTemp473 = 1.4285715f * fTemp472 + fTemp471 + fTemp470;
			float fTemp474 = fRec163[1] + fConst141 * ((fTemp473 - fRec164[1]) / fTemp187);
			float fTemp475 = fTemp474 / fTemp188;
			fRec163[0] = 2.0f * fTemp475 - fRec163[1];
			float fTemp476 = fRec164[1] + fConst141 * (fTemp474 / fTemp384);
			fRec164[0] = 2.0f * fTemp476 - fRec164[1];
			float fRec165 = fTemp475;
			float fRec166 = fTemp476;
			float fTemp477 = fRec166 * fTemp186;
			float fTemp478 = fTemp471 + fTemp470;
			float fTemp479 = fTemp472 + fRec165 * fTemp388;
			float fTemp480 = 1.4285715f * fTemp479 + fTemp478 + fTemp477;
			float fTemp481 = fRec159[1] + fConst2 * ((fTemp480 - fRec160[1]) / fTemp183);
			float fTemp482 = fTemp481 / fTemp184;
			fRec159[0] = 2.0f * fTemp482 - fRec159[1];
			float fTemp483 = fRec160[1] + fConst2 * (fTemp481 / fTemp393);
			fRec160[0] = 2.0f * fTemp483 - fRec160[1];
			float fRec161 = fTemp482;
			float fRec162 = fTemp483;
			float fTemp484 = 1.4285715f * (fTemp479 + fRec161 * fTemp395) + fTemp478 + fTemp477 + fRec162 * fTemp182;
			float fTemp485 = fRec155[1] + fConst2 * fTemp135 * (fTemp484 - fRec156[1]);
			float fTemp486 = fTemp485 / fTemp136;
			fRec155[0] = 2.0f * fTemp486 - fRec155[1];
			float fTemp487 = fRec156[1] + fConst2 * (fTemp135 * fTemp485 / fTemp136);
			fRec156[0] = 2.0f * fTemp487 - fRec156[1];
			float fRec157 = fTemp486;
			float fRec158 = fTemp487;
			float fTemp488 = fRec135[0] * fTemp95 + fTemp401 * (fTemp133 * (fTemp133 * fTemp484 + 1.4285715f * fRec157 * fTemp400) + fRec158 * fTemp134);
			fRec137[0] = fTemp439 * fTemp488;
			float fTemp489 = fSlow13 * fRec136[0] + fSlow10 * fTemp402;
			fVec231[IOTA0 & 2047] = fTemp489;
			float fTemp490 = fSlow13 * fRec137[0] + fSlow10 * fTemp488;
			fVec232[IOTA0 & 2047] = fTemp490;
			float fTemp491 = std::fabs(std::max<float>(std::fabs(fTemp489), std::fabs(fTemp490)));
			int iTemp492 = (fTemp491 >= fRec190[1]) | (float(iRec189[1]) >= fConst179);
			iRec189[0] = ((iTemp492) ? 0 : iRec189[1] + 1);
			fRec190[0] = ((iTemp492) ? fTemp491 : fRec190[1]);
			fRec188[0] = fConst180 * fRec190[0] + fConst178 * fRec188[1];
			float fTemp493 = std::fabs(fRec188[0]);
			fRec187[0] = std::max<float>(fTemp493, fConst181 * fRec187[1] + fConst182 * fTemp493);
			float fTemp494 = std::min<float>(1.0f, 0.8912509f / std::max<float>(fRec187[0], 1.1920929e-07f));
			fVbargraph10 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fTemp494))));
			...
			fRec196[0] = fVec235[1] + fConst46 * (fConst44 * fTemp497 - 2.0f * (fConst42 * fRec196[1] - fConst41 * fVec234[1]));
			fRec195[0] = fRec196[0];
			...
			fRec193[0] = fRec194[0];
			float fTemp498 = mydsp_faustpower2_f(fRec193[0]);
			fVec237[0] = fTemp498;
			float fTemp499 = fTemp498 + fVec237[1];
			fVec238[0] = fTemp499;
			float fTemp500 = fTemp499 + fVec238[2];
			fVec239[0] = fTemp500;
			float fTemp501 = fTemp500 + fVec239[4];
			fVec240[0] = fTemp501;
			float fTemp502 = fTemp501 + fVec240[8];
			fVec241[IOTA0 & 31] = fTemp502;
			float fTemp503 = fTemp502 + fVec241[(IOTA0 - 16) & 31];
			fVec242[IOTA0 & 63] = fTemp503;
			float fTemp504 = fTemp503 + fVec242[(IOTA0 - 32) & 63];
			fVec243[IOTA0 & 127] = fTemp504;
			float fTemp505 = fTemp504 + fVec243[(IOTA0 - 64) & 127];
			fVec244[IOTA0 & 255] = fTemp505;
			float fTemp506 = fTemp505 + fVec244[(IOTA0 - 128) & 255];
			fVec245[IOTA0 & 511] = fTemp506;
			float fTemp507 = fTemp506 + fVec245[(IOTA0 - 256) & 511];
			fVec246[IOTA0 & 1023] = fTemp507;
			float fTemp508 = fTemp507 + fVec246[(IOTA0 - 512) & 1023];
			fVec247[IOTA0 & 2047] = fTemp508;
			float fTemp509 = fTemp508 + fVec247[(IOTA0 - 1024) & 2047];
			fVec248[IOTA0 & 4095] = fTemp509;
			float fTemp510 = fTemp509 + fVec248[(IOTA0 - 2048) & 4095];
			fVec249[IOTA0 & 8191] = fTemp510;
			float fTemp511 = fTemp510 + fVec249[(IOTA0 - 4096) & 8191];
			fVec250[IOTA0 & 16383] = fTemp511;
			float fTemp512 = fTemp511 + fVec250[(IOTA0 - 8192) & 16383];
			fVec251[IOTA0 & 32767] = fTemp512;
			float fTemp513 = fTemp512 + fVec251[(IOTA0 - 16384) & 32767];
			fVec252[IOTA0 & 65535] = fTemp513;
			float fTemp514 = fTemp513 + fVec252[(IOTA0 - 32768) & 65535];
			fVec253[IOTA0 & 131071] = fTemp514;
			float fTemp515 = fTemp514 + fVec253[(IOTA0 - 65536) & 131071];
			fVec254[IOTA0 & 262143] = fTemp515;
			float fTemp516 = fTemp515 + fVec254[(IOTA0 - 131072) & 262143];
			fVec255[IOTA0 & 524287] = fTemp516;
			fVec256[IOTA0 & 1048575] = fTemp516 + fVec255[(IOTA0 - 262144) & 524287];
			fVec257[0] = 0.0f - fConst46 * (fConst48 * fRec199[1] - fConst47 * fVec233[1]);
			fRec200[0] = fVec257[1] + fConst46 * (fConst44 * fTemp496 - 2.0f * (fConst42 * fRec200[1] - fConst41 * fVec233[1]));
			fRec199[0] = fRec200[0];
			...
			fRec197[0] = fRec198[0];
			float fTemp517 = mydsp_faustpower2_f(fRec197[0]);
			fVec259[0] = fTemp517;
			float fTemp518 = fTemp517 + fVec259[1];
			fVec260[0] = fTemp518;
			float fTemp519 = fTemp518 + fVec260[2];
			fVec261[0] = fTemp519;
			float fTemp520 = fTemp519 + fVec261[4];
			fVec262[0] = fTemp520;
			float fTemp521 = fTemp520 + fVec262[8];
			fVec263[IOTA0 & 31] = fTemp521;
			float fTemp522 = fTemp521 + fVec263[(IOTA0 - 16) & 31];
			fVec264[IOTA0 & 63] = fTemp522;
			float fTemp523 = fTemp522 + fVec264[(IOTA0 - 32) & 63];
			fVec265[IOTA0 & 127] = fTemp523;
			float fTemp524 = fTemp523 + fVec265[(IOTA0 - 64) & 127];
			fVec266[IOTA0 & 255] = fTemp524;
			float fTemp525 = fTemp524 + fVec266[(IOTA0 - 128) & 255];
			fVec267[IOTA0 & 511] = fTemp525;
			float fTemp526 = fTemp525 + fVec267[(IOTA0 - 256) & 511];
			fVec268[IOTA0 & 1023] = fTemp526;
			float fTemp527 = fTemp526 + fVec268[(IOTA0 - 512) & 1023];
			fVec269[IOTA0 & 2047] = fTemp527;
			float fTemp528 = fTemp527 + fVec269[(IOTA0 - 1024) & 2047];
			fVec270[IOTA0 & 4095] = fTemp528;
			float fTemp529 = fTemp528 + fVec270[(IOTA0 - 2048) & 4095];
			fVec271[IOTA0 & 8191] = fTemp529;
			float fTemp530 = fTemp529 + fVec271[(IOTA0 - 4096) & 8191];
			fVec272[IOTA0 & 16383] = fTemp530;
			float fTemp531 = fTemp530 + fVec272[(IOTA0 - 8192) & 16383];
			fVec273[IOTA0 & 32767] = fTemp531;
			float fTemp532 = fTemp531 + fVec273[(IOTA0 - 16384) & 32767];
			fVec274[IOTA0 & 65535] = fTemp532;
			float fTemp533 = fTemp532 + fVec274[(IOTA0 - 32768) & 65535];
			fVec275[IOTA0 & 131071] = fTemp533;
			float fTemp534 = fTemp533 + fVec275[(IOTA0 - 65536) & 131071];
			fVec276[IOTA0 & 262143] = fTemp534;
			float fTemp535 = fTemp534 + fVec276[(IOTA0 - 131072) & 262143];
			fVec277[IOTA0 & 524287] = fTemp535;
