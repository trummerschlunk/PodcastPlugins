...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmpiwmtj5y7.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow25 = ((iSlow24) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow24) ? 1.0f : fSlow23)));
		...
		float fSlow70 = ((iSlow69) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow69) ? 1.0f : fSlow68)));
		...
		float fSlow80 = ((iSlow79) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow79) ? 1.0f : fSlow78)));
		...
		float fSlow91 = ((iSlow90) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow90) ? 1.0f : fSlow89)));
		...
		float fSlow101 = ((iSlow100) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow100) ? 1.0f : fSlow99)));
		...
		float fSlow113 = ((iSlow112) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow112) ? 1.0f : fSlow111)));
		...
		float fSlow123 = ((iSlow122) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow122) ? 1.0f : fSlow121)));
		float fSlow124 = 0.05f - 0.04f * fSlow16;
		int iSlow125 = std::fabs(fSlow124) < 1.1920929e-07f;
		float fSlow126 = ((iSlow125) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow125) ? 1.0f : fSlow124)));
		...
		float fSlow134 = ((iSlow133) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow133) ? 1.0f : fSlow132)));
		float fSlow135 = ((iSlow128) ? 0.002f : fSlow131);
		int iSlow136 = std::fabs(fSlow135) < 1.1920929e-07f;
		float fSlow137 = ((iSlow136) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow136) ? 1.0f : fSlow135)));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp585 = (fTemp584 > fSlow75) + (fTemp584 > fSlow76);
			float fTemp586 = 0.0f - fSlow74 * std::max<float>(0.0f, ((iTemp585 == 0) ? 0.0f : ((iTemp585 == 1) ? 0.083333336f * mydsp_faustpower2_f(fSlow19 + (fTemp584 + -3.0f - fSlow2)) : fSlow19 + (fTemp584 + -6.0f - fSlow2))));
			float fTemp587 = ((fTemp586 > fRec185[1]) ? fSlow83 : fSlow80);
			...
			int iTemp590 = (fTemp589 > fSlow75) + (fTemp589 > fSlow76);
			float fTemp591 = 0.0f - fSlow74 * std::max<float>(0.0f, ((iTemp590 == 0) ? 0.0f : ((iTemp590 == 1) ? 0.083333336f * mydsp_faustpower2_f(fSlow19 + (fTemp589 + -3.0f - fSlow2)) : fSlow19 + (fTemp589 + -6.0f - fSlow2))));
			float fTemp592 = ((fTemp591 > fRec188[1]) ? fSlow83 : fSlow80);
			...
			int iTemp604 = (fTemp603 > fSlow85) + (fTemp603 > fSlow87);
			float fTemp605 = fTemp603 + 4e+01f;
			float fTemp606 = std::max<float>(fSlow32, fSlow63 * ((iTemp604 == 0) ? fTemp605 - fSlow84 : ((iTemp604 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp605 - fSlow86) : 0.0f)));
			float fTemp607 = (((fSlow62 * fTemp606) > fRec191[1]) ? fSlow94 : fSlow91);
			...
			int iTemp619 = (fTemp618 > fSlow85) + (fTemp618 > fSlow87);
			float fTemp620 = fTemp618 + 4e+01f;
			float fTemp621 = std::max<float>(fSlow32, fSlow63 * ((iTemp619 == 0) ? fTemp620 - fSlow84 : ((iTemp619 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp620 - fSlow86) : 0.0f)));
			float fTemp622 = (((fSlow62 * fTemp621) > fRec192[1]) ? fSlow94 : fSlow91);
			fRec192[0] = fSlow62 * fTemp621 * (1.0f - fTemp622) + fRec192[1] * fTemp622;
			float fTemp623 = std::min<float>(fSlow16 + std::min<float>(fRec185[0], fRec188[0]), std::max<float>(fRec191[0], fRec192[0]));
			...
			int iTemp653 = (fTemp652 > fSlow97) + (fTemp652 > fSlow98);
			float fTemp654 = 0.0f - fSlow96 * std::max<float>(0.0f, ((iTemp653 == 0) ? 0.0f : ((iTemp653 == 1) ? 0.071428575f * mydsp_faustpower2_f(fSlow19 + (fTemp652 + -0.5f - fSlow2)) : fSlow19 + (fTemp652 + -4.0f - fSlow2))));
			float fTemp655 = ((fTemp654 > fRec201[1]) ? fSlow104 : fSlow101);
			...
			int iTemp658 = (fTemp657 > fSlow97) + (fTemp657 > fSlow98);
			float fTemp659 = 0.0f - fSlow96 * std::max<float>(0.0f, ((iTemp658 == 0) ? 0.0f : ((iTemp658 == 1) ? 0.071428575f * mydsp_faustpower2_f(fSlow19 + (fTemp657 + -0.5f - fSlow2)) : fSlow19 + (fTemp657 + -4.0f - fSlow2))));
			float fTemp660 = ((fTemp659 > fRec204[1]) ? fSlow104 : fSlow101);
			...
			int iTemp672 = (fTemp671 > fSlow39) + (fTemp671 > fSlow42);
			float fTemp673 = fTemp671 + 4e+01f;
			float fTemp674 = std::max<float>(fSlow32, fSlow108 * ((iTemp672 == 0) ? fTemp673 - fSlow35 : ((iTemp672 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp673 - fSlow41) : 0.0f)));
			float fTemp675 = (((fSlow107 * fTemp674) > fRec207[1]) ? fSlow116 : fSlow113);
			fRec207[0] = fSlow107 * fTemp674 * (1.0f - fTemp675) + fRec207[1] * fTemp675;
			...
			int iTemp687 = (fTemp686 > fSlow39) + (fTemp686 > fSlow42);
			float fTemp688 = fTemp686 + 4e+01f;
			float fTemp689 = std::max<float>(fSlow32, fSlow108 * ((iTemp687 == 0) ? fTemp688 - fSlow35 : ((iTemp687 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp688 - fSlow41) : 0.0f)));
			float fTemp690 = (((fSlow107 * fTemp689) > fRec208[1]) ? fSlow116 : fSlow113);
			fRec208[0] = fSlow107 * fTemp689 * (1.0f - fTemp690) + fRec208[1] * fTemp690;
			float fTemp691 = std::min<float>(fSlow16 + std::min<float>(fRec201[0], fRec204[0]), std::max<float>(fRec207[0], fRec208[0]));
