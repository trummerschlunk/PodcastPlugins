...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmpgri_idtb.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow29 = ((iSlow28) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow28) ? 1.0f : fSlow27)));
		float fSlow30 = 0.04f - 0.003f * fSlow19;
		int iSlow31 = std::fabs(fSlow30) < 1.1920929e-07f;
		float fSlow32 = ((iSlow31) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow31) ? 1.0f : fSlow30)));
		...
		float fSlow47 = ((iSlow46) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow46) ? 1.0f : fSlow45)));
		float fSlow48 = ((iSlow34) ? 0.001f : fSlow44);
		int iSlow49 = std::fabs(fSlow48) < 1.1920929e-07f;
		float fSlow50 = ((iSlow49) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow49) ? 1.0f : fSlow48)));
		...
		float fSlow56 = ((iSlow55) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow55) ? 1.0f : fSlow54)));
		float fSlow57 = 0.08f - 0.005f * fSlow19;
		int iSlow58 = std::fabs(fSlow57) < 1.1920929e-07f;
		float fSlow59 = ((iSlow58) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow58) ? 1.0f : fSlow57)));
		...
		float fSlow73 = ((iSlow72) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow72) ? 1.0f : fSlow71)));
		float fSlow74 = ((iSlow61) ? fSlow69 : fSlow70);
		int iSlow75 = std::fabs(fSlow74) < 1.1920929e-07f;
		float fSlow76 = ((iSlow75) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow75) ? 1.0f : fSlow74)));
		...
		float fSlow83 = ((iSlow82) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow82) ? 1.0f : fSlow81)));
		float fSlow84 = 0.07f - 0.004f * fSlow19;
		int iSlow85 = std::fabs(fSlow84) < 1.1920929e-07f;
		float fSlow86 = ((iSlow85) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow85) ? 1.0f : fSlow84)));
		...
		float fSlow94 = ((iSlow93) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow93) ? 1.0f : fSlow92)));
		float fSlow95 = ((iSlow61) ? fSlow69 : fSlow91);
		int iSlow96 = std::fabs(fSlow95) < 1.1920929e-07f;
		float fSlow97 = ((iSlow96) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow96) ? 1.0f : fSlow95)));
		...
		float fSlow104 = ((iSlow103) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow103) ? 1.0f : fSlow102)));
		float fSlow105 = 0.06f - 0.004f * fSlow19;
		int iSlow106 = std::fabs(fSlow105) < 1.1920929e-07f;
		float fSlow107 = ((iSlow106) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow106) ? 1.0f : fSlow105)));
		...
		float fSlow116 = ((iSlow115) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow115) ? 1.0f : fSlow114)));
		float fSlow117 = ((iSlow109) ? fSlow112 : fSlow113);
		int iSlow118 = std::fabs(fSlow117) < 1.1920929e-07f;
		float fSlow119 = ((iSlow118) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow118) ? 1.0f : fSlow117)));
		...
		float fSlow125 = ((iSlow124) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow124) ? 1.0f : fSlow123)));
		float fSlow126 = 0.05f - 0.004f * fSlow19;
		int iSlow127 = std::fabs(fSlow126) < 1.1920929e-07f;
		float fSlow128 = ((iSlow127) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow127) ? 1.0f : fSlow126)));
		...
		float fSlow136 = ((iSlow135) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow135) ? 1.0f : fSlow134)));
		float fSlow137 = ((iSlow130) ? 0.002f : fSlow133);
		int iSlow138 = std::fabs(fSlow137) < 1.1920929e-07f;
		float fSlow139 = ((iSlow138) ? 0.0f : std::exp(0.0f - fConst301 / ((iSlow138) ? 1.0f : fSlow137)));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp578 = fTemp571 + -1.0f;
			float fTemp579 = fRec153 * fTemp578;
			float fTemp580 = mydsp_faustpower2_f(fTemp571) + -1.0f;
			float fTemp581 = fRec154 * fTemp580;
			float fTemp582 = fTemp485 + 1.4285715f * fTemp579 + fTemp581;
			...
			float fTemp632 = fTemp625 + -1.0f;
			float fTemp633 = fTemp579 + fRec183 * fTemp632;
			float fTemp634 = fTemp485 + fTemp581;
			float fTemp635 = mydsp_faustpower2_f(fTemp625) + -1.0f;
			float fTemp636 = fRec184 * fTemp635;
			float fTemp637 = 1.4285715f * fTemp633 + fTemp634 + fTemp636;
			float fTemp638 = std::pow(1e+01f, fTemp624);
			float fTemp639 = std::sqrt(fTemp638);
			float fTemp640 = fRec193[1] + fConst329 * ((fTemp637 - fRec194[1]) / fTemp639);
			float fTemp641 = fConst329 * ((fConst329 / fTemp639 + 1.4285715f) / fTemp639) + 1.0f;
			float fTemp642 = fTemp640 / fTemp641;
			fRec193[0] = 2.0f * fTemp642 - fRec193[1];
			float fTemp643 = fTemp639 * fTemp641;
			float fTemp644 = fRec194[1] + fConst329 * (fTemp640 / fTemp643);
			fRec194[0] = 2.0f * fTemp644 - fRec194[1];
			float fRec195 = fTemp642;
			float fRec196 = fTemp644;
			float fTemp645 = fTemp638 + -1.0f;
			float fTemp646 = fTemp633 + fRec195 * fTemp645;
			float fTemp647 = fTemp634 + fTemp636;
			float fTemp648 = mydsp_faustpower2_f(fTemp638) + -1.0f;
			float fTemp649 = fRec196 * fTemp648;
			float fTemp650 = 1.4285715f * fTemp646 + fTemp647 + fTemp649;
			...
			float fTemp651 = std::fabs(fConst331 * (fConst347 * fRec202[0] + fConst358 * fRec202[1] + fConst347 * fRec202[2]));
			fVec552[0] = fTemp651;
			float fTemp652 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp651));
			int iTemp653 = (fTemp652 > fSlow100) + (fTemp652 > fSlow101);
			float fTemp654 = 0.0f - fSlow99 * std::max<float>(0.0f, ((iTemp653 == 0) ? 0.0f : ((iTemp653 == 1) ? 0.071428575f * mydsp_faustpower2_f(fSlow23 + (fTemp652 + -0.5f - fSlow2)) : fSlow23 + (fTemp652 + -4.0f - fSlow2))));
			float fTemp655 = ((fTemp654 > fRec201[1]) ? fSlow107 : fSlow104);
			fRec201[0] = fTemp654 * (1.0f - fTemp655) + fRec201[1] * fTemp655;
			...
			float fTemp656 = std::fabs(fConst331 * (fConst347 * fRec205[0] + fConst358 * fRec205[1] + fConst347 * fRec205[2]));
			fVec553[0] = fTemp656;
			float fTemp657 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp656));
			int iTemp658 = (fTemp657 > fSlow100) + (fTemp657 > fSlow101);
			float fTemp659 = 0.0f - fSlow99 * std::max<float>(0.0f, ((iTemp658 == 0) ? 0.0f : ((iTemp658 == 1) ? 0.071428575f * mydsp_faustpower2_f(fSlow23 + (fTemp657 + -0.5f - fSlow2)) : fSlow23 + (fTemp657 + -4.0f - fSlow2))));
			float fTemp660 = ((fTemp659 > fRec204[1]) ? fSlow107 : fSlow104);
			fRec204[0] = fTemp659 * (1.0f - fTemp660) + fRec204[1] * fTemp660;
			float fTemp661 = std::max<float>(fTemp651, fVec552[1]);
			fVec554[0] = fTemp661;
			float fTemp662 = std::max<float>(fTemp661, fVec554[2]);
			fVec555[0] = fTemp662;
			float fTemp663 = std::max<float>(fTemp662, fVec555[4]);
			fVec556[0] = fTemp663;
			float fTemp664 = std::max<float>(fTemp663, fVec556[8]);
			fVec557[IOTA0 & 31] = fTemp664;
			float fTemp665 = std::max<float>(fTemp664, fVec557[(IOTA0 - 16) & 31]);
			fVec558[IOTA0 & 63] = fTemp665;
			float fTemp666 = std::max<float>(fTemp665, fVec558[(IOTA0 - 32) & 63]);
			fVec559[IOTA0 & 127] = fTemp666;
			float fTemp667 = std::max<float>(fTemp666, fVec559[(IOTA0 - 64) & 127]);
			fVec560[IOTA0 & 255] = fTemp667;
			float fTemp668 = std::max<float>(fTemp667, fVec560[(IOTA0 - 128) & 255]);
			fVec561[IOTA0 & 511] = fTemp668;
			float fTemp669 = std::max<float>(fTemp668, fVec561[(IOTA0 - 256) & 511]);
			fVec562[IOTA0 & 1023] = fTemp669;
			float fTemp670 = std::max<float>(fTemp669, fVec562[(IOTA0 - 512) & 1023]);
			fVec563[IOTA0 & 2047] = fTemp670;
			fVec564[IOTA0 & 4095] = std::max<float>(fTemp670, fVec563[(IOTA0 - 1024) & 2047]);
			float fTemp671 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst302) ? fTemp651 : -3.4028235e+38f), ((iConst303) ? fVec554[iConst302] : -3.4028235e+38f)), ((iConst304) ? fVec555[iConst305] : -3.4028235e+38f)), ((iConst306) ? fVec556[iConst307] : -3.4028235e+38f)), ((iConst308) ? fVec557[(IOTA0 - iConst309) & 31] : -3.4028235e+38f)), ((iConst310) ? fVec558[(IOTA0 - iConst311) & 63] : -3.4028235e+38f)), ((iConst312) ? fVec559[(IOTA0 - iConst313) & 127] : -3.4028235e+38f)), ((iConst314) ? fVec560[(IOTA0 - iConst315) & 255] : -3.4028235e+38f)), ((iConst316) ? fVec561[(IOTA0 - iConst317) & 511] : -3.4028235e+38f)), ((iConst318) ? fVec562[(IOTA0 - iConst319) & 1023] : -3.4028235e+38f)), ((iConst320) ? fVec563[(IOTA0 - iConst321) & 2047] : -3.4028235e+38f)), ((iConst322) ? fVec564[(IOTA0 - iConst323) & 4095] : -3.4028235e+38f))));
			int iTemp672 = (fTemp671 > fSlow39) + (fTemp671 > fSlow41);
			float fTemp673 = fTemp671 + 4e+01f;
			float fTemp674 = std::max<float>(fSlow36, fSlow111 * ((iTemp672 == 0) ? fTemp673 - fSlow43 : ((iTemp672 == 1) ? fSlow42 * mydsp_faustpower2_f(fTemp673 - fSlow40) : 0.0f)));
			float fTemp675 = (((fSlow110 * fTemp674) > fRec207[1]) ? fSlow119 : fSlow116);
			fRec207[0] = fSlow110 * fTemp674 * (1.0f - fTemp675) + fRec207[1] * fTemp675;
			float fTemp676 = std::max<float>(fTemp656, fVec553[1]);
			fVec565[0] = fTemp676;
			float fTemp677 = std::max<float>(fTemp676, fVec565[2]);
			fVec566[0] = fTemp677;
			float fTemp678 = std::max<float>(fTemp677, fVec566[4]);
			fVec567[0] = fTemp678;
			float fTemp679 = std::max<float>(fTemp678, fVec567[8]);
			fVec568[IOTA0 & 31] = fTemp679;
			float fTemp680 = std::max<float>(fTemp679, fVec568[(IOTA0 - 16) & 31]);
			fVec569[IOTA0 & 63] = fTemp680;
			float fTemp681 = std::max<float>(fTemp680, fVec569[(IOTA0 - 32) & 63]);
			fVec570[IOTA0 & 127] = fTemp681;
			float fTemp682 = std::max<float>(fTemp681, fVec570[(IOTA0 - 64) & 127]);
			fVec571[IOTA0 & 255] = fTemp682;
			float fTemp683 = std::max<float>(fTemp682, fVec571[(IOTA0 - 128) & 255]);
			fVec572[IOTA0 & 511] = fTemp683;
			float fTemp684 = std::max<float>(fTemp683, fVec572[(IOTA0 - 256) & 511]);
			fVec573[IOTA0 & 1023] = fTemp684;
			float fTemp685 = std::max<float>(fTemp684, fVec573[(IOTA0 - 512) & 1023]);
			fVec574[IOTA0 & 2047] = fTemp685;
			fVec575[IOTA0 & 4095] = std::max<float>(fTemp685, fVec574[(IOTA0 - 1024) & 2047]);
			float fTemp686 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst302) ? fTemp656 : -3.4028235e+38f), ((iConst303) ? fVec565[iConst302] : -3.4028235e+38f)), ((iConst304) ? fVec566[iConst305] : -3.4028235e+38f)), ((iConst306) ? fVec567[iConst307] : -3.4028235e+38f)), ((iConst308) ? fVec568[(IOTA0 - iConst309) & 31] : -3.4028235e+38f)), ((iConst310) ? fVec569[(IOTA0 - iConst311) & 63] : -3.4028235e+38f)), ((iConst312) ? fVec570[(IOTA0 - iConst313) & 127] : -3.4028235e+38f)), ((iConst314) ? fVec571[(IOTA0 - iConst315) & 255] : -3.4028235e+38f)), ((iConst316) ? fVec572[(IOTA0 - iConst317) & 511] : -3.4028235e+38f)), ((iConst318) ? fVec573[(IOTA0 - iConst319) & 1023] : -3.4028235e+38f)), ((iConst320) ? fVec574[(IOTA0 - iConst321) & 2047] : -3.4028235e+38f)), ((iConst322) ? fVec575[(IOTA0 - iConst323) & 4095] : -3.4028235e+38f))));
			int iTemp687 = (fTemp686 > fSlow39) + (fTemp686 > fSlow41);
			float fTemp688 = fTemp686 + 4e+01f;
			float fTemp689 = std::max<float>(fSlow36, fSlow111 * ((iTemp687 == 0) ? fTemp688 - fSlow43 : ((iTemp687 == 1) ? fSlow42 * mydsp_faustpower2_f(fTemp688 - fSlow40) : 0.0f)));
			float fTemp690 = (((fSlow110 * fTemp689) > fRec208[1]) ? fSlow119 : fSlow116);
			fRec208[0] = fSlow110 * fTemp689 * (1.0f - fTemp690) + fRec208[1] * fTemp690;
			float fTemp691 = std::min<float>(fSlow20 + std::min<float>(fRec201[0], fRec204[0]), std::max<float>(fRec207[0], fRec208[0]));
			fVbargraph26 = FAUSTFLOAT(std::min<float>(12.0f, std::max<float>(-12.0f, fTemp691)));
			float fTemp692 = 0.025f * fTemp691;
			float fTemp693 = std::pow(1e+01f, 0.0f - fTemp692);
			float fTemp694 = std::sqrt(fTemp693);
			float fTemp695 = fRec197[1] + fConst329 * ((fTemp650 - fRec198[1]) / fTemp694);
			float fTemp696 = fConst329 * ((fConst329 / fTemp694 + 1.4285715f) / fTemp694) + 1.0f;
			float fTemp697 = fTemp695 / fTemp696;
			fRec197[0] = 2.0f * fTemp697 - fRec197[1];
			float fTemp698 = fTemp694 * fTemp696;
			float fTemp699 = fRec198[1] + fConst329 * (fTemp695 / fTemp698);
			fRec198[0] = 2.0f * fTemp699 - fRec198[1];
			float fRec199 = fTemp697;
			float fRec200 = fTemp699;
			float fTemp700 = fTemp693 + -1.0f;
			float fTemp701 = fTemp646 + fRec199 * fTemp700;
			float fTemp702 = fTemp647 + fTemp649;
			float fTemp703 = mydsp_faustpower2_f(fTemp693) + -1.0f;
			float fTemp704 = fRec200 * fTemp703;
			float fTemp705 = 1.4285715f * fTemp701 + fTemp702 + fTemp704;
			float fTemp706 = std::pow(1e+01f, fTemp692);
			float fTemp707 = std::sqrt(fTemp706);
			float fTemp708 = fRec209[1] + fConst334 * ((fTemp705 - fRec210[1]) / fTemp707);
			float fTemp709 = fConst334 * ((fConst334 / fTemp707 + 1.4285715f) / fTemp707) + 1.0f;
			float fTemp710 = fTemp708 / fTemp709;
			fRec209[0] = 2.0f * fTemp710 - fRec209[1];
			float fTemp711 = fTemp707 * fTemp709;
			float fTemp712 = fRec210[1] + fConst334 * (fTemp708 / fTemp711);
			fRec210[0] = 2.0f * fTemp712 - fRec210[1];
			float fRec211 = fTemp710;
			float fRec212 = fTemp712;
			float fTemp713 = fTemp706 + -1.0f;
			float fTemp714 = fTemp701 + fRec211 * fTemp713;
			float fTemp715 = fTemp702 + fTemp704;
			float fTemp716 = mydsp_faustpower2_f(fTemp706) + -1.0f;
			float fTemp717 = fRec212 * fTemp716;
			float fTemp718 = 1.4285715f * fTemp714 + fTemp715 + fTemp717;
			...
			float fTemp719 = std::fabs(fConst336 * (fConst341 * fRec218[0] + fConst359 * fRec218[1] + fConst341 * fRec218[2]));
			fVec576[0] = fTemp719;
			float fTemp720 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp719));
			int iTemp721 = (fTemp720 > fSlow121) + (fTemp720 > fSlow122);
			float fTemp722 = 0.0f - fSlow120 * std::max<float>(0.0f, ((iTemp721 == 0) ? 0.0f : ((iTemp721 == 1) ? 0.0625f * mydsp_faustpower2_f(fSlow23 + (fTemp720 + 2.0f - fSlow2)) : fSlow23 + (fTemp720 + -2.0f - fSlow2))));
			float fTemp723 = ((fTemp722 > fRec217[1]) ? fSlow128 : fSlow125);
			fRec217[0] = fTemp722 * (1.0f - fTemp723) + fRec217[1] * fTemp723;
			...
			float fTemp724 = std::fabs(fConst336 * (fConst341 * fRec221[0] + fConst359 * fRec221[1] + fConst341 * fRec221[2]));
			fVec577[0] = fTemp724;
			float fTemp725 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp724));
			int iTemp726 = (fTemp725 > fSlow121) + (fTemp725 > fSlow122);
			float fTemp727 = 0.0f - fSlow120 * std::max<float>(0.0f, ((iTemp726 == 0) ? 0.0f : ((iTemp726 == 1) ? 0.0625f * mydsp_faustpower2_f(fSlow23 + (fTemp725 + 2.0f - fSlow2)) : fSlow23 + (fTemp725 + -2.0f - fSlow2))));
			float fTemp728 = ((fTemp727 > fRec220[1]) ? fSlow128 : fSlow125);
			fRec220[0] = fTemp727 * (1.0f - fTemp728) + fRec220[1] * fTemp728;
			float fTemp729 = std::max<float>(fTemp719, fVec576[1]);
			fVec578[0] = fTemp729;
			float fTemp730 = std::max<float>(fTemp729, fVec578[2]);
			fVec579[0] = fTemp730;
			float fTemp731 = std::max<float>(fTemp730, fVec579[4]);
			fVec580[0] = fTemp731;
			float fTemp732 = std::max<float>(fTemp731, fVec580[8]);
			fVec581[IOTA0 & 31] = fTemp732;
			float fTemp733 = std::max<float>(fTemp732, fVec581[(IOTA0 - 16) & 31]);
			fVec582[IOTA0 & 63] = fTemp733;
			float fTemp734 = std::max<float>(fTemp733, fVec582[(IOTA0 - 32) & 63]);
			fVec583[IOTA0 & 127] = fTemp734;
			float fTemp735 = std::max<float>(fTemp734, fVec583[(IOTA0 - 64) & 127]);
			fVec584[IOTA0 & 255] = fTemp735;
			float fTemp736 = std::max<float>(fTemp735, fVec584[(IOTA0 - 128) & 255]);
			fVec585[IOTA0 & 511] = fTemp736;
			float fTemp737 = std::max<float>(fTemp736, fVec585[(IOTA0 - 256) & 511]);
			fVec586[IOTA0 & 1023] = fTemp737;
			float fTemp738 = std::max<float>(fTemp737, fVec586[(IOTA0 - 512) & 1023]);
			fVec587[IOTA0 & 2047] = fTemp738;
			fVec588[IOTA0 & 4095] = std::max<float>(fTemp738, fVec587[(IOTA0 - 1024) & 2047]);
			float fTemp739 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst302) ? fTemp719 : -3.4028235e+38f), ((iConst303) ? fVec578[iConst302] : -3.4028235e+38f)), ((iConst304) ? fVec579[iConst305] : -3.4028235e+38f)), ((iConst306) ? fVec580[iConst307] : -3.4028235e+38f)), ((iConst308) ? fVec581[(IOTA0 - iConst309) & 31] : -3.4028235e+38f)), ((iConst310) ? fVec582[(IOTA0 - iConst311) & 63] : -3.4028235e+38f)), ((iConst312) ? fVec583[(IOTA0 - iConst313) & 127] : -3.4028235e+38f)), ((iConst314) ? fVec584[(IOTA0 - iConst315) & 255] : -3.4028235e+38f)), ((iConst316) ? fVec585[(IOTA0 - iConst317) & 511] : -3.4028235e+38f)), ((iConst318) ? fVec586[(IOTA0 - iConst319) & 1023] : -3.4028235e+38f)), ((iConst320) ? fVec587[(IOTA0 - iConst321) & 2047] : -3.4028235e+38f)), ((iConst322) ? fVec588[(IOTA0 - iConst323) & 4095] : -3.4028235e+38f))));
			int iTemp740 = (fTemp739 > fSlow39) + (fTemp739 > fSlow41);
			float fTemp741 = fTemp739 + 4e+01f;
			float fTemp742 = std::max<float>(fSlow36, fSlow132 * ((iTemp740 == 0) ? fTemp741 - fSlow43 : ((iTemp740 == 1) ? fSlow42 * mydsp_faustpower2_f(fTemp741 - fSlow40) : 0.0f)));
			float fTemp743 = (((fSlow131 * fTemp742) > fRec223[1]) ? fSlow139 : fSlow136);
			fRec223[0] = fSlow131 * fTemp742 * (1.0f - fTemp743) + fRec223[1] * fTemp743;
			float fTemp744 = std::max<float>(fTemp724, fVec577[1]);
			fVec589[0] = fTemp744;
			float fTemp745 = std::max<float>(fTemp744, fVec589[2]);
			fVec590[0] = fTemp745;
			float fTemp746 = std::max<float>(fTemp745, fVec590[4]);
			fVec591[0] = fTemp746;
			float fTemp747 = std::max<float>(fTemp746, fVec591[8]);
			fVec592[IOTA0 & 31] = fTemp747;
			float fTemp748 = std::max<float>(fTemp747, fVec592[(IOTA0 - 16) & 31]);
			fVec593[IOTA0 & 63] = fTemp748;
			float fTemp749 = std::max<float>(fTemp748, fVec593[(IOTA0 - 32) & 63]);
			fVec594[IOTA0 & 127] = fTemp749;
			float fTemp750 = std::max<float>(fTemp749, fVec594[(IOTA0 - 64) & 127]);
			fVec595[IOTA0 & 255] = fTemp750;
			float fTemp751 = std::max<float>(fTemp750, fVec595[(IOTA0 - 128) & 255]);
			fVec596[IOTA0 & 511] = fTemp751;
			float fTemp752 = std::max<float>(fTemp751, fVec596[(IOTA0 - 256) & 511]);
			fVec597[IOTA0 & 1023] = fTemp752;
			float fTemp753 = std::max<float>(fTemp752, fVec597[(IOTA0 - 512) & 1023]);
			fVec598[IOTA0 & 2047] = fTemp753;
			fVec599[IOTA0 & 4095] = std::max<float>(fTemp753, fVec598[(IOTA0 - 1024) & 2047]);
			float fTemp754 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst302) ? fTemp724 : -3.4028235e+38f), ((iConst303) ? fVec589[iConst302] : -3.4028235e+38f)), ((iConst304) ? fVec590[iConst305] : -3.4028235e+38f)), ((iConst306) ? fVec591[iConst307] : -3.4028235e+38f)), ((iConst308) ? fVec592[(IOTA0 - iConst309) & 31] : -3.4028235e+38f)), ((iConst310) ? fVec593[(IOTA0 - iConst311) & 63] : -3.4028235e+38f)), ((iConst312) ? fVec594[(IOTA0 - iConst313) & 127] : -3.4028235e+38f)), ((iConst314) ? fVec595[(IOTA0 - iConst315) & 255] : -3.4028235e+38f)), ((iConst316) ? fVec596[(IOTA0 - iConst317) & 511] : -3.4028235e+38f)), ((iConst318) ? fVec597[(IOTA0 - iConst319) & 1023] : -3.4028235e+38f)), ((iConst320) ? fVec598[(IOTA0 - iConst321) & 2047] : -3.4028235e+38f)), ((iConst322) ? fVec599[(IOTA0 - iConst323) & 4095] : -3.4028235e+38f))));
			int iTemp755 = (fTemp754 > fSlow39) + (fTemp754 > fSlow41);
			float fTemp756 = fTemp754 + 4e+01f;
			float fTemp757 = std::max<float>(fSlow36, fSlow132 * ((iTemp755 == 0) ? fTemp756 - fSlow43 : ((iTemp755 == 1) ? fSlow42 * mydsp_faustpower2_f(fTemp756 - fSlow40) : 0.0f)));
			float fTemp758 = (((fSlow131 * fTemp757) > fRec224[1]) ? fSlow139 : fSlow136);
			fRec224[0] = fSlow131 * fTemp757 * (1.0f - fTemp758) + fRec224[1] * fTemp758;
			float fTemp759 = std::min<float>(fSlow20 + std::min<float>(fRec217[0], fRec220[0]), std::max<float>(fRec223[0], fRec224[0]));
			fVbargraph27 = FAUSTFLOAT(std::min<float>(12.0f, std::max<float>(-12.0f, fTemp759)));
			float fTemp760 = 0.025f * fTemp759;
			float fTemp761 = std::pow(1e+01f, 0.0f - fTemp760);
			float fTemp762 = std::sqrt(fTemp761);
			float fTemp763 = fRec213[1] + fConst334 * ((fTemp718 - fRec214[1]) / fTemp762);
			float fTemp764 = fConst334 * ((fConst334 / fTemp762 + 1.4285715f) / fTemp762) + 1.0f;
			float fTemp765 = fTemp763 / fTemp764;
			fRec213[0] = 2.0f * fTemp765 - fRec213[1];
			float fTemp766 = fTemp762 * fTemp764;
			float fTemp767 = fRec214[1] + fConst334 * (fTemp763 / fTemp766);
			fRec214[0] = 2.0f * fTemp767 - fRec214[1];
			float fRec215 = fTemp765;
			float fRec216 = fTemp767;
			float fTemp768 = fTemp761 + -1.0f;
			float fTemp769 = fTemp714 + fRec215 * fTemp768;
			float fTemp770 = fTemp715 + fTemp717;
			float fTemp771 = mydsp_faustpower2_f(fTemp761) + -1.0f;
			float fTemp772 = fRec216 * fTemp771;
			float fTemp773 = 1.4285715f * fTemp769 + fTemp770 + fTemp772;
			float fTemp774 = std::pow(1e+01f, fTemp760);
			float fTemp775 = std::sqrt(fTemp774);
			float fTemp776 = fRec225[1] + fConst289 * ((fTemp773 - fRec226[1]) / fTemp775);
			float fTemp777 = fConst289 * ((fConst289 / fTemp775 + 1.4285715f) / fTemp775) + 1.0f;
			float fTemp778 = fTemp776 / fTemp777;
			fRec225[0] = 2.0f * fTemp778 - fRec225[1];
			float fTemp779 = fTemp775 * fTemp777;
			float fTemp780 = fRec226[1] + fConst289 * (fTemp776 / fTemp779);
			fRec226[0] = 2.0f * fTemp780 - fRec226[1];
			float fRec227 = fTemp778;
			float fRec228 = fTemp780;
			float fTemp781 = fTemp774 + -1.0f;
			float fTemp782 = mydsp_faustpower2_f(fTemp774) + -1.0f;
			float fTemp783 = 1.4285715f * (fTemp769 + fRec227 * fTemp781) + fTemp770 + fTemp772 + fRec228 * fTemp782;
			float fTemp784 = std::sqrt(fTemp529);
			float fTemp785 = fRec229[1] + fConst289 * fTemp784 * (fTemp783 - fRec230[1]);
			float fTemp786 = fConst289 * fTemp784 * (fConst289 * fTemp784 + 1.4285715f) + 1.0f;
			float fTemp787 = fTemp785 / fTemp786;
			fRec229[0] = 2.0f * fTemp787 - fRec229[1];
			float fTemp788 = fRec230[1] + fConst289 * (fTemp784 * fTemp785 / fTemp786);
			fRec230[0] = 2.0f * fTemp788 - fRec230[1];
			float fRec231 = fTemp787;
			float fRec232 = fTemp788;
			float fTemp789 = 1.0f - fTemp529;
			float fTemp790 = 1.0f - mydsp_faustpower2_f(fTemp529);
			float fTemp791 = fRec6[0] * fTemp485 + fTemp486 * (fTemp529 * (fTemp529 * fTemp783 + 1.4285715f * fRec231 * fTemp789) + fRec232 * fTemp790);
			fVec600[IOTA0 & 2047] = fTemp791;
			float fTemp792 = fRec233[1] + fConst324 * ((fTemp492 - fRec234[1]) / fTemp572);
			float fTemp793 = fTemp792 / fTemp574;
			fRec233[0] = 2.0f * fTemp793 - fRec233[1];
			float fTemp794 = fRec234[1] + fConst324 * (fTemp792 / fTemp576);
			fRec234[0] = 2.0f * fTemp794 - fRec234[1];
			float fRec235 = fTemp793;
			float fRec236 = fTemp794;
			float fTemp795 = fRec236 * fTemp580;
			float fTemp796 = fTemp492 + fTemp795;
			float fTemp797 = fRec235 * fTemp578;
			float fTemp798 = fTemp492 + 1.4285715f * fTemp797 + fTemp795;
			float fTemp799 = fRec237[1] + fConst324 * ((fTemp798 - fRec238[1]) / fTemp626);
			float fTemp800 = fTemp799 / fTemp628;
			fRec237[0] = 2.0f * fTemp800 - fRec237[1];
			float fTemp801 = fRec238[1] + fConst324 * (fTemp799 / fTemp630);
			fRec238[0] = 2.0f * fTemp801 - fRec238[1];
			float fRec239 = fTemp800;
			float fRec240 = fTemp801;
			float fTemp802 = fRec240 * fTemp635;
			float fTemp803 = fTemp796 + fTemp802;
			float fTemp804 = fTemp797 + fRec239 * fTemp632;
			float fTemp805 = 1.4285715f * fTemp804 + fTemp796 + fTemp802;
			float fTemp806 = fRec241[1] + fConst329 * ((fTemp805 - fRec242[1]) / fTemp639);
			float fTemp807 = fTemp806 / fTemp641;
			fRec241[0] = 2.0f * fTemp807 - fRec241[1];
			float fTemp808 = fRec242[1] + fConst329 * (fTemp806 / fTemp643);
			fRec242[0] = 2.0f * fTemp808 - fRec242[1];
			float fRec243 = fTemp807;
			float fRec244 = fTemp808;
			float fTemp809 = fRec244 * fTemp648;
			float fTemp810 = fTemp803 + fTemp809;
			float fTemp811 = fTemp804 + fRec243 * fTemp645;
			float fTemp812 = 1.4285715f * fTemp811 + fTemp803 + fTemp809;
			float fTemp813 = fRec245[1] + fConst329 * ((fTemp812 - fRec246[1]) / fTemp694);
			float fTemp814 = fTemp813 / fTemp696;
			fRec245[0] = 2.0f * fTemp814 - fRec245[1];
			float fTemp815 = fRec246[1] + fConst329 * (fTemp813 / fTemp698);
			fRec246[0] = 2.0f * fTemp815 - fRec246[1];
			float fRec247 = fTemp814;
			float fRec248 = fTemp815;
			float fTemp816 = fRec248 * fTemp703;
			float fTemp817 = fTemp811 + fRec247 * fTemp700;
			float fTemp818 = 1.4285715f * fTemp817 + fTemp810 + fTemp816;
			float fTemp819 = fRec249[1] + fConst334 * ((fTemp818 - fRec250[1]) / fTemp707);
			float fTemp820 = fTemp819 / fTemp709;
			fRec249[0] = 2.0f * fTemp820 - fRec249[1];
			float fTemp821 = fRec250[1] + fConst334 * (fTemp819 / fTemp711);
			fRec250[0] = 2.0f * fTemp821 - fRec250[1];
			float fRec251 = fTemp820;
			float fRec252 = fTemp821;
			float fTemp822 = fTemp810 + fTemp816 + fRec252 * fTemp716;
			float fTemp823 = fTemp817 + fRec251 * fTemp713;
			float fTemp824 = 1.4285715f * fTemp823 + fTemp822;
			float fTemp825 = fRec253[1] + fConst334 * ((fTemp824 - fRec254[1]) / fTemp762);
			float fTemp826 = fTemp825 / fTemp764;
			fRec253[0] = 2.0f * fTemp826 - fRec253[1];
			float fTemp827 = fRec254[1] + fConst334 * (fTemp825 / fTemp766);
			fRec254[0] = 2.0f * fTemp827 - fRec254[1];
			float fRec255 = fTemp826;
			float fRec256 = fTemp827;
			float fTemp828 = fTemp822 + fRec256 * fTemp771;
			float fTemp829 = fTemp823 + fRec255 * fTemp768;
			float fTemp830 = 1.4285715f * fTemp829 + fTemp828;
			float fTemp831 = fRec257[1] + fConst289 * ((fTemp830 - fRec258[1]) / fTemp775);
			float fTemp832 = fTemp831 / fTemp777;
			fRec257[0] = 2.0f * fTemp832 - fRec257[1];
			float fTemp833 = fRec258[1] + fConst289 * (fTemp831 / fTemp779);
			fRec258[0] = 2.0f * fTemp833 - fRec258[1];
			float fRec259 = fTemp832;
			float fRec260 = fTemp833;
			float fTemp834 = fTemp828 + 1.4285715f * (fTemp829 + fRec259 * fTemp781) + fRec260 * fTemp782;
			float fTemp835 = fRec261[1] + fConst289 * fTemp784 * (fTemp834 - fRec262[1]);
			float fTemp836 = fTemp835 / fTemp786;
			fRec261[0] = 2.0f * fTemp836 - fRec261[1];
			float fTemp837 = fRec262[1] + fConst289 * (fTemp784 * fTemp835 / fTemp786);
			fRec262[0] = 2.0f * fTemp837 - fRec262[1];
			float fRec263 = fTemp836;
			float fRec264 = fTemp837;
			float fTemp838 = fRec6[0] * fTemp492 + fTemp486 * (fTemp529 * (fTemp529 * fTemp834 + 1.4285715f * fRec263 * fTemp789) + fRec264 * fTemp790);
			fVec601[IOTA0 & 2047] = fTemp838;
			float fTemp839 = std::fabs(std::max<float>(std::fabs(fTemp791), std::fabs(fTemp838)));
			int iTemp840 = (fTemp839 >= fRec5[1]) | (float(iRec4[1]) >= fConst135);
			iRec4[0] = ((iTemp840) ? 0 : iRec4[1] + 1);
			fRec5[0] = ((iTemp840) ? fTemp839 : fRec5[1]);
			fRec3[0] = fConst5 * fRec5[0] + fConst4 * fRec3[1];
			float fTemp841 = std::fabs(fRec3[0]);
			fRec2[0] = std::max<float>(fTemp841, fConst360 * fRec2[1] + fConst361 * fTemp841);
			float fTemp842 = std::min<float>(1.0f, 0.8912509f / std::max<float>(fRec2[0], 1.1920929e-07f));
			fVbargraph28 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fTemp842))));
			float fTemp843 = fTemp842 * (1.0f - fRec1[0]);
			float fTemp844 = fTemp0 * fRec1[0] + fTemp843 * fVec600[(IOTA0 - iConst362) & 2047];
			fRec0[0] = std::max<float>(fRec0[1] - fConst1, std::min<float>(1e+01f, 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(0.00031622776f, std::fabs(fTemp844))))));
			fVbargraph30 = FAUSTFLOAT(fRec0[0]);
			float fTemp845 = fTemp844;
			fVec602[0] = fTemp845;
			output0[i0] = FAUSTFLOAT(fTemp845);
			fVec603[0] = 0.0f - fConst30 * (fConst31 * fRec267[1] - fConst33 * fVec602[1]);
			fRec268[0] = fVec603[1] + fConst30 * (fConst34 * fTemp845 - 2.0f * (fConst35 * fRec268[1] - fConst36 * fVec602[1]));
			fRec267[0] = fRec268[0];
			...
			fVec605[0] = fTemp846;
			float fTemp847 = fTemp846 + fVec605[1];
			fVec606[0] = fTemp847;
			float fTemp848 = fTemp847 + fVec606[2];
			fVec607[0] = fTemp848;
			float fTemp849 = fTemp848 + fVec607[4];
			fVec608[0] = fTemp849;
			float fTemp850 = fTemp849 + fVec608[8];
			fVec609[IOTA0 & 31] = fTemp850;
			float fTemp851 = fTemp850 + fVec609[(IOTA0 - 16) & 31];
			fVec610[IOTA0 & 63] = fTemp851;
			float fTemp852 = fTemp851 + fVec610[(IOTA0 - 32) & 63];
			fVec611[IOTA0 & 127] = fTemp852;
			float fTemp853 = fTemp852 + fVec611[(IOTA0 - 64) & 127];
			fVec612[IOTA0 & 255] = fTemp853;
			float fTemp854 = fTemp853 + fVec612[(IOTA0 - 128) & 255];
			fVec613[IOTA0 & 511] = fTemp854;
			float fTemp855 = fTemp854 + fVec613[(IOTA0 - 256) & 511];
			fVec614[IOTA0 & 1023] = fTemp855;
			float fTemp856 = fTemp855 + fVec614[(IOTA0 - 512) & 1023];
			fVec615[IOTA0 & 2047] = fTemp856;
			float fTemp857 = fTemp856 + fVec615[(IOTA0 - 1024) & 2047];
			fVec616[IOTA0 & 4095] = fTemp857;
			float fTemp858 = fTemp857 + fVec616[(IOTA0 - 2048) & 4095];
			fVec617[IOTA0 & 8191] = fTemp858;
			float fTemp859 = fTemp858 + fVec617[(IOTA0 - 4096) & 8191];
			fVec618[IOTA0 & 16383] = fTemp859;
			float fTemp860 = fTemp859 + fVec618[(IOTA0 - 8192) & 16383];
			fVec619[IOTA0 & 32767] = fTemp860;
			float fTemp861 = fTemp860 + fVec619[(IOTA0 - 16384) & 32767];
			fVec620[IOTA0 & 65535] = fTemp861;
			fVec621[IOTA0 & 131071] = fTemp861 + fVec620[(IOTA0 - 32768) & 65535];
			float fTemp862 = fTemp42 * fRec1[0] + fTemp843 * fVec601[(IOTA0 - iConst362) & 2047];
			fRec273[0] = std::max<float>(fRec273[1] - fConst1, std::min<float>(1e+01f, 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(0.00031622776f, std::fabs(fTemp862))))));
			fVbargraph31 = FAUSTFLOAT(fRec273[0]);
			float fTemp863 = fTemp862;
			fVec622[0] = fTemp863;
			fVec623[0] = 0.0f - fConst30 * (fConst31 * fRec271[1] - fConst33 * fVec622[1]);
			fRec272[0] = fVec623[1] + fConst30 * (fConst34 * fTemp863 - 2.0f * (fConst35 * fRec272[1] - fConst36 * fVec622[1]));
			fRec271[0] = fRec272[0];
			...
			fRec269[0] = fRec270[0];
			float fTemp864 = mydsp_faustpower2_f(fRec269[0]);
			fVec625[0] = fTemp864;
			float fTemp865 = fTemp864 + fVec625[1];
			fVec626[0] = fTemp865;
			float fTemp866 = fTemp865 + fVec626[2];
			fVec627[0] = fTemp866;
			float fTemp867 = fTemp866 + fVec627[4];
			fVec628[0] = fTemp867;
			float fTemp868 = fTemp867 + fVec628[8];
			fVec629[IOTA0 & 31] = fTemp868;
			float fTemp869 = fTemp868 + fVec629[(IOTA0 - 16) & 31];
			fVec630[IOTA0 & 63] = fTemp869;
			float fTemp870 = fTemp869 + fVec630[(IOTA0 - 32) & 63];
			fVec631[IOTA0 & 127] = fTemp870;
			float fTemp871 = fTemp870 + fVec631[(IOTA0 - 64) & 127];
			fVec632[IOTA0 & 255] = fTemp871;
			float fTemp872 = fTemp871 + fVec632[(IOTA0 - 128) & 255];
			fVec633[IOTA0 & 511] = fTemp872;
			float fTemp873 = fTemp872 + fVec633[(IOTA0 - 256) & 511];
			fVec634[IOTA0 & 1023] = fTemp873;
			float fTemp874 = fTemp873 + fVec634[(IOTA0 - 512) & 1023];
			fVec635[IOTA0 & 2047] = fTemp874;
			float fTemp875 = fTemp874 + fVec635[(IOTA0 - 1024) & 2047];
			fVec636[IOTA0 & 4095] = fTemp875;
			float fTemp876 = fTemp875 + fVec636[(IOTA0 - 2048) & 4095];
			fVec637[IOTA0 & 8191] = fTemp876;
			float fTemp877 = fTemp876 + fVec637[(IOTA0 - 4096) & 8191];
			fVec638[IOTA0 & 16383] = fTemp877;
			float fTemp878 = fTemp877 + fVec638[(IOTA0 - 8192) & 16383];
			fVec639[IOTA0 & 32767] = fTemp878;
			float fTemp879 = fTemp878 + fVec639[(IOTA0 - 16384) & 32767];
			fVec640[IOTA0 & 65535] = fTemp879;
			fVec641[IOTA0 & 131071] = fTemp879 + fVec640[(IOTA0 - 32768) & 65535];
			fVbargraph32 = FAUSTFLOAT(4.3429446f * std::log(std::max<float>(1e-12f, fConst364 * (((iConst365) ? 0.86000985f * fVec621[(IOTA0 - iConst396) & 131071] : 0.0f) + ((iConst395) ? 0.86000985f * fVec620[(IOTA0 - iConst394) & 65535] : 0.0f) + ((iConst393) ? 0.86000985f * fVec619[(IOTA0 - iConst392) & 32767] : 0.0f) + ((iConst391) ? 0.86000985f * fVec618[(IOTA0 - iConst390) & 16383] : 0.0f) + ((iConst389) ? 0.86000985f * fVec617[(IOTA0 - iConst388) & 8191] : 0.0f) + ((iConst387) ? 0.86000985f * fVec616[(IOTA0 - iConst386) & 4095] : 0.0f) + ((iConst385) ? 0.86000985f * fVec615[(IOTA0 - iConst384) & 2047] : 0.0f) + ((iConst383) ? 0.86000985f * fVec614[(IOTA0 - iConst382) & 1023] : 0.0f) + ((iConst381) ? 0.86000985f * fVec613[(IOTA0 - iConst380) & 511] : 0.0f) + ((iConst379) ? 0.86000985f * fVec612[(IOTA0 - iConst378) & 255] : 0.0f) + ((iConst377) ? 0.86000985f * fVec611[(IOTA0 - iConst376) & 127] : 0.0f) + ((iConst375) ? 0.86000985f * fVec610[(IOTA0 - iConst374) & 63] : 0.0f) + ((iConst373) ? 0.86000985f * fVec609[(IOTA0 - iConst372) & 31] : 0.0f) + ((iConst371) ? 0.86000985f * fVec608[iConst370] : 0.0f) + ((iConst369) ? 0.86000985f * fVec607[iConst368] : 0.0f) + ((iConst366) ? 0.86000985f * fTemp846 : 0.0f) + ((iConst367) ? 0.86000985f * fVec606[iConst366] : 0.0f) + ((iConst365) ? 0.86000985f * fVec641[(IOTA0 - iConst396) & 131071] : 0.0f) + ((iConst395) ? 0.86000985f * fVec640[(IOTA0 - iConst394) & 65535] : 0.0f) + ((iConst393) ? 0.86000985f * fVec639[(IOTA0 - iConst392) & 32767] : 0.0f) + ((iConst391) ? 0.86000985f * fVec638[(IOTA0 - iConst390) & 16383] : 0.0f) + ((iConst389) ? 0.86000985f * fVec637[(IOTA0 - iConst388) & 8191] : 0.0f) + ((iConst387) ? 0.86000985f * fVec636[(IOTA0 - iConst386) & 4095] : 0.0f) + ((iConst385) ? 0.86000985f * fVec635[(IOTA0 - iConst384) & 2047] : 0.0f) + ((iConst383) ? 0.86000985f * fVec634[(IOTA0 - iConst382) & 1023] : 0.0f) + ((iConst381) ? 0.86000985f * fVec633[(IOTA0 - iConst380) & 511] : 0.0f) + ((iConst379) ? 0.86000985f * fVec632[(IOTA0 - iConst378) & 255] : 0.0f) + ((iConst377) ? 0.86000985f * fVec631[(IOTA0 - iConst376) & 127] : 0.0f) + ((iConst375) ? 0.86000985f * fVec630[(IOTA0 - iConst374) & 63] : 0.0f) + ((iConst373) ? 0.86000985f * fVec629[(IOTA0 - iConst372) & 31] : 0.0f) + ((iConst371) ? 0.86000985f * fVec628[iConst370] : 0.0f) + ((iConst369) ? 0.86000985f * fVec627[iConst368] : 0.0f) + ((iConst366) ? 0.86000985f * fTemp864 : 0.0f) + ((iConst367) ? 0.86000985f * fVec626[iConst366] : 0.0f)))) + -0.691f);
			output1[i0] = FAUSTFLOAT(fTemp863);
			fRec1[1] = fRec1[0];
			fRec6[1] = fRec6[0];
			fVec0[1] = fVec0[0];
			fVec1[2] = fVec1[1];
