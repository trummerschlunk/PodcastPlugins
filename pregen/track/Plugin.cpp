...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmppgx3wemi.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp757 = fRec192 * fTemp629;
			float fTemp758 = fTemp749 + fTemp748;
			float fTemp759 = fTemp628 + -1.0f;
			float fTemp760 = fTemp751 + fRec191 * fTemp759;
			float fTemp761 = 1.4285715f * fTemp760 + fTemp758 + fTemp757;
			float fTemp762 = fRec185[1] + fConst322 * ((fTemp761 - fRec186[1]) / fTemp626);
			float fTemp763 = fTemp762 / fTemp627;
			fRec185[0] = 2.0f * fTemp763 - fRec185[1];
			float fTemp764 = fTemp626 * fTemp627;
			float fTemp765 = fRec186[1] + fConst322 * (fTemp762 / fTemp764);
			fRec186[0] = 2.0f * fTemp765 - fRec186[1];
			float fRec187 = fTemp763;
			float fRec188 = fTemp765;
			float fTemp766 = fTemp758 + fTemp757 + fRec188 * fTemp625;
			float fTemp767 = fTemp624 + -1.0f;
			float fTemp768 = fTemp760 + fRec187 * fTemp767;
			float fTemp769 = 1.4285715f * fTemp768 + fTemp766;
			float fTemp770 = fRec167[1] + fConst322 * ((fTemp769 - fRec168[1]) / fTemp580);
			float fTemp771 = fTemp770 / fTemp581;
			fRec167[0] = 2.0f * fTemp771 - fRec167[1];
			float fTemp772 = fTemp580 * fTemp581;
			float fTemp773 = fRec168[1] + fConst322 * (fTemp770 / fTemp772);
			fRec168[0] = 2.0f * fTemp773 - fRec168[1];
			float fRec169 = fTemp771;
			float fRec170 = fTemp773;
			float fTemp774 = fRec170 * fTemp579;
			float fTemp775 = fTemp578 + -1.0f;
			float fTemp776 = fTemp768 + fRec169 * fTemp775;
			float fTemp777 = fTemp766 + 1.4285715f * fTemp776 + fTemp774;
			float fTemp778 = fRec163[1] + fConst2 * ((fTemp777 - fRec164[1]) / fTemp576);
			float fTemp779 = fTemp778 / fTemp577;
			fRec163[0] = 2.0f * fTemp779 - fRec163[1];
			float fTemp780 = fTemp576 * fTemp577;
			float fTemp781 = fRec164[1] + fConst2 * (fTemp778 / fTemp780);
			fRec164[0] = 2.0f * fTemp781 - fRec164[1];
			float fRec165 = fTemp779;
			float fRec166 = fTemp781;
			float fTemp782 = fTemp574 + -1.0f;
			float fTemp783 = 1.4285715f * (fTemp776 + fRec165 * fTemp782) + fTemp766 + fTemp774 + fRec166 * fTemp575;
			float fTemp784 = fRec145[1] + fConst2 * fTemp530 * (fTemp783 - fRec146[1]);
			float fTemp785 = fTemp784 / fTemp531;
			fRec145[0] = 2.0f * fTemp785 - fRec145[1];
			float fTemp786 = fRec146[1] + fConst2 * (fTemp530 * fTemp784 / fTemp531);
			fRec146[0] = 2.0f * fTemp786 - fRec146[1];
			float fRec147 = fTemp785;
			float fRec148 = fTemp786;
			float fTemp787 = 1.0f - fTemp528;
			fRec227[0] = fSlow138 + fConst20 * fRec227[1];
			float fTemp788 = 1.0f - fRec227[0];
			float fTemp789 = fRec227[0] * fTemp485 + fTemp788 * (fTemp528 * (fTemp528 * fTemp783 + 1.4285715f * fRec147 * fTemp787) + fRec148 * fTemp529);
			fVec600[IOTA0 & 2047] = fTemp789;
			float fTemp790 = fRec260[1] + fConst346 * ((fTemp491 - fRec261[1]) / fTemp725);
			float fTemp791 = fTemp790 / fTemp726;
			fRec260[0] = 2.0f * fTemp791 - fRec260[1];
			float fTemp792 = fRec261[1] + fConst346 * (fTemp790 / fTemp729);
			fRec261[0] = 2.0f * fTemp792 - fRec261[1];
			float fRec262 = fTemp791;
			float fRec263 = fTemp792;
			float fTemp793 = fRec263 * fTemp724;
			float fTemp794 = fRec262 * fTemp732;
			float fTemp795 = fTemp491 + 1.4285715f * fTemp794 + fTemp793;
			float fTemp796 = fRec256[1] + fConst346 * ((fTemp795 - fRec257[1]) / fTemp680);
			float fTemp797 = fTemp796 / fTemp681;
			fRec256[0] = 2.0f * fTemp797 - fRec256[1];
			float fTemp798 = fRec257[1] + fConst346 * (fTemp796 / fTemp737);
			fRec257[0] = 2.0f * fTemp798 - fRec257[1];
			float fRec258 = fTemp797;
			float fRec259 = fTemp798;
			float fTemp799 = fRec259 * fTemp679;
			float fTemp800 = fTemp491 + fTemp793;
			float fTemp801 = fTemp794 + fRec258 * fTemp741;
			float fTemp802 = 1.4285715f * fTemp801 + fTemp800 + fTemp799;
			float fTemp803 = fRec252[1] + fConst334 * ((fTemp802 - fRec253[1]) / fTemp676);
			float fTemp804 = fTemp803 / fTemp677;
			fRec252[0] = 2.0f * fTemp804 - fRec252[1];
			float fTemp805 = fRec253[1] + fConst334 * (fTemp803 / fTemp746);
			fRec253[0] = 2.0f * fTemp805 - fRec253[1];
			float fRec254 = fTemp804;
			float fRec255 = fTemp805;
			float fTemp806 = fRec255 * fTemp675;
			float fTemp807 = fTemp800 + fTemp799;
			float fTemp808 = fTemp801 + fRec254 * fTemp750;
			float fTemp809 = 1.4285715f * fTemp808 + fTemp807 + fTemp806;
			float fTemp810 = fRec248[1] + fConst334 * ((fTemp809 - fRec249[1]) / fTemp630);
			float fTemp811 = fTemp810 / fTemp631;
			fRec248[0] = 2.0f * fTemp811 - fRec248[1];
			float fTemp812 = fRec249[1] + fConst334 * (fTemp810 / fTemp755);
			fRec249[0] = 2.0f * fTemp812 - fRec249[1];
			float fRec250 = fTemp811;
			float fRec251 = fTemp812;
			float fTemp813 = fTemp807 + fTemp806 + fRec251 * fTemp629;
			float fTemp814 = fTemp808 + fRec250 * fTemp759;
			float fTemp815 = 1.4285715f * fTemp814 + fTemp813;
			...
			float fTemp818 = fRec245[1] + fConst322 * (fTemp816 / fTemp764);
			fRec245[0] = 2.0f * fTemp818 - fRec245[1];
			float fRec246 = fTemp817;
			float fRec247 = fTemp818;
			float fTemp819 = fRec247 * fTemp625;
			float fTemp820 = fTemp814 + fRec246 * fTemp767;
			float fTemp821 = fTemp813 + 1.4285715f * fTemp820 + fTemp819;
			...
			float fTemp824 = fRec241[1] + fConst322 * (fTemp822 / fTemp772);
			fRec241[0] = 2.0f * fTemp824 - fRec241[1];
			float fRec242 = fTemp823;
			float fRec243 = fTemp824;
			float fTemp825 = fRec243 * fTemp579;
			float fTemp826 = fTemp813 + fTemp819;
			float fTemp827 = fTemp820 + fRec242 * fTemp775;
			...
			float fTemp831 = fRec237[1] + fConst2 * (fTemp829 / fTemp780);
			fRec237[0] = 2.0f * fTemp831 - fRec237[1];
			float fRec238 = fTemp830;
			float fRec239 = fTemp831;
			float fTemp832 = 1.4285715f * (fTemp827 + fRec238 * fTemp782) + fTemp826 + fTemp825 + fRec239 * fTemp575;
			...
			float fTemp836 = fRec227[0] * fTemp491 + fTemp788 * (fTemp528 * (fTemp528 * fTemp832 + 1.4285715f * fRec234 * fTemp787) + fRec235 * fTemp529);
			fVec601[IOTA0 & 2047] = fTemp836;
			float fTemp837 = std::fabs(std::max<float>(std::fabs(fTemp789), std::fabs(fTemp836)));
