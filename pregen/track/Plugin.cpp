...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmp55bfdkgg.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp702 = mydsp_faustpower2_f(fTemp693) + -1.0f;
			float fTemp703 = fTemp647 + fTemp649 + fRec200 * fTemp702;
			float fTemp704 = 1.4285715f * fTemp701 + fTemp703;
			float fTemp705 = std::pow(1e+01f, fTemp692);
			...
			float fTemp712 = fTemp705 + -1.0f;
			float fTemp713 = fTemp701 + fRec211 * fTemp712;
			float fTemp714 = mydsp_faustpower2_f(fTemp705) + -1.0f;
			float fTemp715 = fRec212 * fTemp714;
			float fTemp716 = fTemp703 + 1.4285715f * fTemp713 + fTemp715;
			...
			float fTemp766 = fTemp759 + -1.0f;
			float fTemp767 = fTemp713 + fRec215 * fTemp766;
			float fTemp768 = fTemp703 + fTemp715;
			float fTemp769 = mydsp_faustpower2_f(fTemp759) + -1.0f;
			float fTemp770 = fRec216 * fTemp769;
			float fTemp771 = 1.4285715f * fTemp767 + fTemp768 + fTemp770;
			float fTemp772 = std::pow(1e+01f, fTemp758);
			float fTemp773 = std::sqrt(fTemp772);
			float fTemp774 = fRec225[1] + fConst289 * ((fTemp771 - fRec226[1]) / fTemp773);
			float fTemp775 = fConst289 * ((fConst289 / fTemp773 + 1.4285715f) / fTemp773) + 1.0f;
			float fTemp776 = fTemp774 / fTemp775;
			fRec225[0] = 2.0f * fTemp776 - fRec225[1];
			float fTemp777 = fTemp773 * fTemp775;
			float fTemp778 = fRec226[1] + fConst289 * (fTemp774 / fTemp777);
			fRec226[0] = 2.0f * fTemp778 - fRec226[1];
			float fRec227 = fTemp776;
			float fRec228 = fTemp778;
			float fTemp779 = fTemp772 + -1.0f;
			float fTemp780 = mydsp_faustpower2_f(fTemp772) + -1.0f;
			float fTemp781 = 1.4285715f * (fTemp767 + fRec227 * fTemp779) + fTemp768 + fTemp770 + fRec228 * fTemp780;
			float fTemp782 = std::sqrt(fTemp529);
			float fTemp783 = fRec229[1] + fConst289 * fTemp782 * (fTemp781 - fRec230[1]);
			float fTemp784 = fConst289 * fTemp782 * (fConst289 * fTemp782 + 1.4285715f) + 1.0f;
			float fTemp785 = fTemp783 / fTemp784;
			fRec229[0] = 2.0f * fTemp785 - fRec229[1];
			float fTemp786 = fRec230[1] + fConst289 * (fTemp782 * fTemp783 / fTemp784);
			fRec230[0] = 2.0f * fTemp786 - fRec230[1];
			float fRec231 = fTemp785;
			float fRec232 = fTemp786;
			float fTemp787 = 1.0f - fTemp529;
			float fTemp788 = 1.0f - mydsp_faustpower2_f(fTemp529);
			float fTemp789 = fRec6[0] * fTemp485 + fTemp486 * (fTemp529 * (fTemp529 * fTemp781 + 1.4285715f * fRec231 * fTemp787) + fRec232 * fTemp788);
			fVec600[IOTA0 & 2047] = fTemp789;
			float fTemp790 = fRec233[1] + fConst324 * ((fTemp492 - fRec234[1]) / fTemp572);
			float fTemp791 = fTemp790 / fTemp574;
			fRec233[0] = 2.0f * fTemp791 - fRec233[1];
			float fTemp792 = fRec234[1] + fConst324 * (fTemp790 / fTemp576);
			fRec234[0] = 2.0f * fTemp792 - fRec234[1];
			float fRec235 = fTemp791;
			float fRec236 = fTemp792;
			float fTemp793 = fRec235 * fTemp578;
			float fTemp794 = fRec236 * fTemp580;
			float fTemp795 = fTemp492 + 1.4285715f * fTemp793 + fTemp794;
			float fTemp796 = fRec237[1] + fConst324 * ((fTemp795 - fRec238[1]) / fTemp626);
			float fTemp797 = fTemp796 / fTemp628;
			fRec237[0] = 2.0f * fTemp797 - fRec237[1];
			float fTemp798 = fRec238[1] + fConst324 * (fTemp796 / fTemp630);
			fRec238[0] = 2.0f * fTemp798 - fRec238[1];
			float fRec239 = fTemp797;
			float fRec240 = fTemp798;
			float fTemp799 = fTemp793 + fRec239 * fTemp632;
			float fTemp800 = fTemp492 + fTemp794;
			float fTemp801 = fRec240 * fTemp635;
			float fTemp802 = 1.4285715f * fTemp799 + fTemp800 + fTemp801;
			float fTemp803 = fRec241[1] + fConst329 * ((fTemp802 - fRec242[1]) / fTemp639);
			float fTemp804 = fTemp803 / fTemp641;
			fRec241[0] = 2.0f * fTemp804 - fRec241[1];
			float fTemp805 = fRec242[1] + fConst329 * (fTemp803 / fTemp643);
			fRec242[0] = 2.0f * fTemp805 - fRec242[1];
			float fRec243 = fTemp804;
			float fRec244 = fTemp805;
			float fTemp806 = fTemp799 + fRec243 * fTemp645;
			float fTemp807 = fTemp800 + fTemp801;
			float fTemp808 = fRec244 * fTemp648;
			float fTemp809 = 1.4285715f * fTemp806 + fTemp807 + fTemp808;
			float fTemp810 = fRec245[1] + fConst329 * ((fTemp809 - fRec246[1]) / fTemp694);
			float fTemp811 = fTemp810 / fTemp696;
			fRec245[0] = 2.0f * fTemp811 - fRec245[1];
			float fTemp812 = fRec246[1] + fConst329 * (fTemp810 / fTemp698);
			fRec246[0] = 2.0f * fTemp812 - fRec246[1];
			float fRec247 = fTemp811;
			float fRec248 = fTemp812;
			float fTemp813 = fTemp806 + fRec247 * fTemp700;
			float fTemp814 = fTemp807 + fTemp808;
			float fTemp815 = fRec248 * fTemp702;
			float fTemp816 = 1.4285715f * fTemp813 + fTemp814 + fTemp815;
			float fTemp817 = fRec249[1] + fConst334 * ((fTemp816 - fRec250[1]) / fTemp706);
			float fTemp818 = fTemp817 / fTemp708;
			fRec249[0] = 2.0f * fTemp818 - fRec249[1];
			float fTemp819 = fRec250[1] + fConst334 * (fTemp817 / fTemp710);
			fRec250[0] = 2.0f * fTemp819 - fRec250[1];
			float fRec251 = fTemp818;
			float fRec252 = fTemp819;
			float fTemp820 = fTemp813 + fRec251 * fTemp712;
			float fTemp821 = fTemp814 + fTemp815;
			float fTemp822 = fRec252 * fTemp714;
			float fTemp823 = 1.4285715f * fTemp820 + fTemp821 + fTemp822;
			float fTemp824 = fRec253[1] + fConst334 * ((fTemp823 - fRec254[1]) / fTemp760);
			float fTemp825 = fTemp824 / fTemp762;
			fRec253[0] = 2.0f * fTemp825 - fRec253[1];
			float fTemp826 = fRec254[1] + fConst334 * (fTemp824 / fTemp764);
			fRec254[0] = 2.0f * fTemp826 - fRec254[1];
			float fRec255 = fTemp825;
			float fRec256 = fTemp826;
			float fTemp827 = fTemp820 + fRec255 * fTemp766;
			float fTemp828 = fTemp821 + fTemp822;
			float fTemp829 = fRec256 * fTemp769;
			float fTemp830 = 1.4285715f * fTemp827 + fTemp828 + fTemp829;
			float fTemp831 = fRec257[1] + fConst289 * ((fTemp830 - fRec258[1]) / fTemp773);
			float fTemp832 = fTemp831 / fTemp775;
			fRec257[0] = 2.0f * fTemp832 - fRec257[1];
			float fTemp833 = fRec258[1] + fConst289 * (fTemp831 / fTemp777);
			fRec258[0] = 2.0f * fTemp833 - fRec258[1];
			float fRec259 = fTemp832;
			float fRec260 = fTemp833;
			float fTemp834 = 1.4285715f * (fTemp827 + fRec259 * fTemp779) + fTemp828 + fTemp829 + fRec260 * fTemp780;
			float fTemp835 = fRec261[1] + fConst289 * fTemp782 * (fTemp834 - fRec262[1]);
			float fTemp836 = fTemp835 / fTemp784;
			fRec261[0] = 2.0f * fTemp836 - fRec261[1];
			float fTemp837 = fRec262[1] + fConst289 * (fTemp782 * fTemp835 / fTemp784);
			fRec262[0] = 2.0f * fTemp837 - fRec262[1];
			float fRec263 = fTemp836;
			float fRec264 = fTemp837;
			float fTemp838 = fRec6[0] * fTemp492 + fTemp486 * (fTemp529 * (fTemp529 * fTemp834 + 1.4285715f * fRec263 * fTemp787) + fRec264 * fTemp788);
			fVec601[IOTA0 & 2047] = fTemp838;
			float fTemp839 = std::fabs(std::max<float>(std::fabs(fTemp789), std::fabs(fTemp838)));
