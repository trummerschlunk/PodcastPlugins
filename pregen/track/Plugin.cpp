...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmplc021aic.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("In 0", &fVbargraph1, FAUSTFLOAT(-6e+01f), FAUSTFLOAT(12.0f));
		ui_interface->declare(&fVbargraph0, "symbol", "input_peak_channel_1");
		ui_interface->addVerticalBargraph("In 1", &fVbargraph0, FAUSTFLOAT(-6e+01f), FAUSTFLOAT(12.0f));
		ui_interface->closeBox();
		ui_interface->declare(0, "2", "");
