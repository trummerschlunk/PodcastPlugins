...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmpq039_017.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void instanceConstants(int sample_rate) {
		...
		fConst323 = std::tan(314.15927f / fConst0);
		float fConst324 = 1.0f / fConst323;
		fConst325 = 1.0f / ((fConst324 + 0.5176381f) / fConst323 + 1.0f);
		fConst326 = 1.0f / ((fConst324 + 1.4142135f) / fConst323 + 1.0f);
		fConst327 = 1.0f / ((fConst324 + 1.9318516f) / fConst323 + 1.0f);
		fConst328 = std::tan(1294.74f / fConst0);
		float fConst329 = 1.0f / fConst328;
		fConst330 = 1.0f / ((fConst329 + 0.5176381f) / fConst328 + 1.0f);
		fConst331 = 1.0f / ((fConst329 + 1.4142135f) / fConst328 + 1.0f);
		fConst332 = 1.0f / ((fConst329 + 1.9318516f) / fConst328 + 1.0f);
		fConst333 = std::tan(5335.9927f / fConst0);
		float fConst334 = 1.0f / fConst333;
		fConst335 = 1.0f / ((fConst334 + 0.5176381f) / fConst333 + 1.0f);
		fConst336 = 1.0f / ((fConst334 + 1.4142135f) / fConst333 + 1.0f);
		fConst337 = 1.0f / ((fConst334 + 1.9318516f) / fConst333 + 1.0f);
		fConst338 = (fConst334 + -1.9318516f) / fConst333 + 1.0f;
		float fConst339 = mydsp_faustpower2_f(fConst333);
		fConst340 = 1.0f / fConst339;
		fConst341 = 2.0f * (1.0f - fConst340);
		fConst342 = (fConst334 + -1.4142135f) / fConst333 + 1.0f;
		fConst343 = (fConst334 + -0.5176381f) / fConst333 + 1.0f;
		fConst344 = (fConst329 + -1.9318516f) / fConst328 + 1.0f;
		float fConst345 = mydsp_faustpower2_f(fConst328);
		fConst346 = 1.0f / fConst345;
		fConst347 = 2.0f * (1.0f - fConst346);
		fConst348 = (fConst329 + -1.4142135f) / fConst328 + 1.0f;
		fConst349 = (fConst329 + -0.5176381f) / fConst328 + 1.0f;
		fConst350 = (fConst324 + -1.9318516f) / fConst323 + 1.0f;
		float fConst351 = mydsp_faustpower2_f(fConst323);
		fConst352 = 1.0f / fConst351;
		fConst353 = 2.0f * (1.0f - fConst352);
		fConst354 = (fConst324 + -1.4142135f) / fConst323 + 1.0f;
		fConst355 = (fConst324 + -0.5176381f) / fConst323 + 1.0f;
		fConst356 = 0.0f - 2.0f / fConst351;
		fConst357 = 0.0f - 2.0f / fConst345;
		fConst358 = 0.0f - 2.0f / fConst339;
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow51 = 0.2f * fSlow17;
		float fSlow52 = fSlow2 + (-3.0f - fSlow16);
		float fSlow53 = fSlow2 + (3.0f - fSlow16);
		float fSlow54 = 0.015f - 0.005f * fSlow16;
		int iSlow55 = std::fabs(fSlow54) < 1.1920929e-07f;
		float fSlow56 = ((iSlow55) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow55) ? 1.0f : fSlow54)));
		float fSlow57 = 0.08f - 0.05f * fSlow16;
		int iSlow58 = std::fabs(fSlow57) < 1.1920929e-07f;
		float fSlow59 = ((iSlow58) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow58) ? 1.0f : fSlow57)));
		float fSlow60 = 1e+01f * fSlow17;
		int iSlow61 = fSlow60 > 0.0f;
		float fSlow62 = float(2 * iSlow61 + -1);
		float fSlow63 = std::fabs(fSlow60);
		float fSlow64 = fSlow2 + fSlow38;
		float fSlow65 = fSlow40 + -4e+01f;
		float fSlow66 = 0.005f * fSlow17;
		float fSlow67 = 1.0f - 0.5f * fSlow16;
		float fSlow68 = ((iSlow61) ? fSlow67 : fSlow66);
		int iSlow69 = std::fabs(fSlow68) < 1.1920929e-07f;
		float fSlow70 = ((iSlow69) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow69) ? 1.0f : fSlow68)));
		float fSlow71 = ((iSlow61) ? fSlow66 : fSlow67);
		int iSlow72 = std::fabs(fSlow71) < 1.1920929e-07f;
		float fSlow73 = ((iSlow72) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow72) ? 1.0f : fSlow71)));
		float fSlow74 = 0.3f * fSlow16 + 0.2f;
		float fSlow75 = fSlow2 + (3.0f - fSlow19);
		float fSlow76 = fSlow2 + (9.0f - fSlow19);
		float fSlow77 = 0.004f * fSlow16;
		float fSlow78 = 0.012f - fSlow77;
		int iSlow79 = std::fabs(fSlow78) < 1.1920929e-07f;
		float fSlow80 = ((iSlow79) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow79) ? 1.0f : fSlow78)));
		float fSlow81 = 0.07f - 0.04f * fSlow16;
		int iSlow82 = std::fabs(fSlow81) < 1.1920929e-07f;
		float fSlow83 = ((iSlow82) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow82) ? 1.0f : fSlow81)));
		float fSlow84 = fSlow2 + fSlow19;
		float fSlow85 = fSlow84 + fSlow38;
		float fSlow86 = fSlow19 + fSlow40;
		float fSlow87 = fSlow86 + -4e+01f;
		float fSlow88 = 0.8f - 0.4f * fSlow16;
		float fSlow89 = ((iSlow61) ? fSlow88 : fSlow66);
		int iSlow90 = std::fabs(fSlow89) < 1.1920929e-07f;
		float fSlow91 = ((iSlow90) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow90) ? 1.0f : fSlow89)));
		float fSlow92 = ((iSlow61) ? fSlow66 : fSlow88);
		int iSlow93 = std::fabs(fSlow92) < 1.1920929e-07f;
		float fSlow94 = ((iSlow93) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow93) ? 1.0f : fSlow92)));
		float fSlow95 = 0.4f * fSlow16;
		float fSlow96 = fSlow95 + 0.2f;
		float fSlow97 = fSlow2 + (0.5f - fSlow19);
		float fSlow98 = fSlow2 + (7.5f - fSlow19);
		float fSlow99 = 0.01f - fSlow77;
		int iSlow100 = std::fabs(fSlow99) < 1.1920929e-07f;
		float fSlow101 = ((iSlow100) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow100) ? 1.0f : fSlow99)));
		float fSlow102 = 0.06f - 0.04f * fSlow16;
		int iSlow103 = std::fabs(fSlow102) < 1.1920929e-07f;
		float fSlow104 = ((iSlow103) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow103) ? 1.0f : fSlow102)));
		float fSlow105 = 2e+01f * fSlow16 + 1e+01f;
		int iSlow106 = fSlow105 > 0.0f;
		float fSlow107 = float(2 * iSlow106 + -1);
		float fSlow108 = std::fabs(fSlow105);
		float fSlow109 = fSlow22 + 0.002f;
		float fSlow110 = 0.6f - fSlow95;
		float fSlow111 = ((iSlow106) ? fSlow110 : fSlow109);
		int iSlow112 = std::fabs(fSlow111) < 1.1920929e-07f;
		float fSlow113 = ((iSlow112) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow112) ? 1.0f : fSlow111)));
		float fSlow114 = ((iSlow106) ? fSlow109 : fSlow110);
		int iSlow115 = std::fabs(fSlow114) < 1.1920929e-07f;
		float fSlow116 = ((iSlow115) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow115) ? 1.0f : fSlow114)));
		float fSlow117 = fSlow95 + 0.3f;
		float fSlow118 = fSlow2 + 2.0f * (1.0f - fSlow16);
		float fSlow119 = fSlow118 + -4.0f;
		float fSlow120 = fSlow118 + 4.0f;
		float fSlow121 = 0.008f - fSlow77;
		int iSlow122 = std::fabs(fSlow121) < 1.1920929e-07f;
		float fSlow123 = ((iSlow122) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow122) ? 1.0f : fSlow121)));
		float fSlow124 = 0.05f - 0.04f * fSlow16;
		int iSlow125 = std::fabs(fSlow124) < 1.1920929e-07f;
		float fSlow126 = ((iSlow125) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow125) ? 1.0f : fSlow124)));
		float fSlow127 = 25.0f * fSlow16 + 1e+01f;
		int iSlow128 = fSlow127 > 0.0f;
		float fSlow129 = float(2 * iSlow128 + -1);
		float fSlow130 = std::fabs(fSlow127);
		float fSlow131 = 0.4f - 0.3f * fSlow16;
		float fSlow132 = ((iSlow128) ? fSlow131 : 0.002f);
		int iSlow133 = std::fabs(fSlow132) < 1.1920929e-07f;
		float fSlow134 = ((iSlow133) ? 0.0f : std::exp(0.0f - fConst300 / ((iSlow133) ? 1.0f : fSlow132)));
		float fSlow135 = ((iSlow128) ? 0.002f : fSlow131);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec166[0] = fConst294 * (fRec144[2] + fRec144[0] + 2.0f * fRec144[1]) - fConst293 * (fConst298 * fRec166[2] + fConst296 * fRec166[1]);
			fRec165[0] = fConst293 * (fRec166[2] + fRec166[0] + 2.0f * fRec166[1]) - fConst290 * (fConst299 * fRec165[2] + fConst296 * fRec165[1]);
			fRec164[0] = fConst290 * (fRec165[2] + fRec165[0] + 2.0f * fRec165[1]) - fConst337 * (fConst338 * fRec164[2] + fConst341 * fRec164[1]);
			fRec163[0] = fConst337 * (fRec164[2] + fRec164[0] + 2.0f * fRec164[1]) - fConst336 * (fConst342 * fRec163[2] + fConst341 * fRec163[1]);
			fRec162[0] = fConst336 * (fRec163[2] + fRec163[0] + 2.0f * fRec163[1]) - fConst335 * (fConst343 * fRec162[2] + fConst341 * fRec162[1]);
			fRec161[0] = fConst335 * (fRec162[2] + fRec162[0] + 2.0f * fRec162[1]) - fConst332 * (fConst344 * fRec161[2] + fConst347 * fRec161[1]);
			fRec160[0] = fConst332 * (fRec161[2] + fRec161[0] + 2.0f * fRec161[1]) - fConst331 * (fConst348 * fRec160[2] + fConst347 * fRec160[1]);
			fRec159[0] = fConst331 * (fRec160[2] + fRec160[0] + 2.0f * fRec160[1]) - fConst330 * (fConst349 * fRec159[2] + fConst347 * fRec159[1]);
			fRec158[0] = fConst330 * (fRec159[2] + fRec159[0] + 2.0f * fRec159[1]) - fConst327 * (fConst350 * fRec158[2] + fConst353 * fRec158[1]);
			fRec157[0] = fConst327 * (fRec158[2] + fRec158[0] + 2.0f * fRec158[1]) - fConst326 * (fConst354 * fRec157[2] + fConst353 * fRec157[1]);
			fRec156[0] = fConst326 * (fRec157[2] + fRec157[0] + 2.0f * fRec157[1]) - fConst325 * (fConst355 * fRec156[2] + fConst353 * fRec156[1]);
			float fTemp530 = std::fabs(fConst325 * (fRec156[2] + fRec156[0] + 2.0f * fRec156[1]));
			fVec504[0] = fTemp530;
			float fTemp531 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp530));
			int iTemp532 = (fTemp531 > fSlow52) + (fTemp531 > fSlow53);
			float fTemp533 = 0.0f - fSlow51 * std::max<float>(0.0f, ((iTemp532 == 0) ? 0.0f : ((iTemp532 == 1) ? 0.083333336f * mydsp_faustpower2_f(fSlow16 + (fTemp531 + 3.0f - fSlow2)) : fSlow16 + (fTemp531 - fSlow2))));
			float fTemp534 = ((fTemp533 > fRec155[1]) ? fSlow59 : fSlow56);
			fRec155[0] = fTemp533 * (1.0f - fTemp534) + fRec155[1] * fTemp534;
			fRec178[0] = fConst294 * (fRec148[2] + fRec148[0] + 2.0f * fRec148[1]) - fConst293 * (fConst298 * fRec178[2] + fConst296 * fRec178[1]);
			fRec177[0] = fConst293 * (fRec178[2] + fRec178[0] + 2.0f * fRec178[1]) - fConst290 * (fConst299 * fRec177[2] + fConst296 * fRec177[1]);
			fRec176[0] = fConst290 * (fRec177[2] + fRec177[0] + 2.0f * fRec177[1]) - fConst337 * (fConst338 * fRec176[2] + fConst341 * fRec176[1]);
			fRec175[0] = fConst337 * (fRec176[2] + fRec176[0] + 2.0f * fRec176[1]) - fConst336 * (fConst342 * fRec175[2] + fConst341 * fRec175[1]);
			fRec174[0] = fConst336 * (fRec175[2] + fRec175[0] + 2.0f * fRec175[1]) - fConst335 * (fConst343 * fRec174[2] + fConst341 * fRec174[1]);
			fRec173[0] = fConst335 * (fRec174[2] + fRec174[0] + 2.0f * fRec174[1]) - fConst332 * (fConst344 * fRec173[2] + fConst347 * fRec173[1]);
			fRec172[0] = fConst332 * (fRec173[2] + fRec173[0] + 2.0f * fRec173[1]) - fConst331 * (fConst348 * fRec172[2] + fConst347 * fRec172[1]);
			fRec171[0] = fConst331 * (fRec172[2] + fRec172[0] + 2.0f * fRec172[1]) - fConst330 * (fConst349 * fRec171[2] + fConst347 * fRec171[1]);
			fRec170[0] = fConst330 * (fRec171[2] + fRec171[0] + 2.0f * fRec171[1]) - fConst327 * (fConst350 * fRec170[2] + fConst353 * fRec170[1]);
			fRec169[0] = fConst327 * (fRec170[2] + fRec170[0] + 2.0f * fRec170[1]) - fConst326 * (fConst354 * fRec169[2] + fConst353 * fRec169[1]);
			fRec168[0] = fConst326 * (fRec169[2] + fRec169[0] + 2.0f * fRec169[1]) - fConst325 * (fConst355 * fRec168[2] + fConst353 * fRec168[1]);
			float fTemp535 = std::fabs(fConst325 * (fRec168[2] + fRec168[0] + 2.0f * fRec168[1]));
			fVec505[0] = fTemp535;
			float fTemp536 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp535));
			int iTemp537 = (fTemp536 > fSlow52) + (fTemp536 > fSlow53);
			float fTemp538 = 0.0f - fSlow51 * std::max<float>(0.0f, ((iTemp537 == 0) ? 0.0f : ((iTemp537 == 1) ? 0.083333336f * mydsp_faustpower2_f(fSlow16 + (fTemp536 + 3.0f - fSlow2)) : fSlow16 + (fTemp536 - fSlow2))));
			...
			int iTemp551 = (fTemp550 > fSlow64) + (fTemp550 > fSlow65);
			float fTemp552 = fTemp550 + 4e+01f;
			float fTemp553 = std::max<float>(fSlow32, fSlow63 * ((iTemp551 == 0) ? fTemp552 - fSlow2 : ((iTemp551 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp552 - fSlow40) : 0.0f)));
			float fTemp554 = (((fSlow62 * fTemp553) > fRec179[1]) ? fSlow73 : fSlow70);
			...
			int iTemp566 = (fTemp565 > fSlow64) + (fTemp565 > fSlow65);
			float fTemp567 = fTemp565 + 4e+01f;
			float fTemp568 = std::max<float>(fSlow32, fSlow63 * ((iTemp566 == 0) ? fTemp567 - fSlow2 : ((iTemp566 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp567 - fSlow40) : 0.0f)));
			float fTemp569 = (((fSlow62 * fTemp568) > fRec180[1]) ? fSlow73 : fSlow70);
			fRec180[0] = fSlow62 * fTemp568 * (1.0f - fTemp569) + fRec180[1] * fTemp569;
			float fTemp570 = std::min<float>(fSlow16 + std::min<float>(fRec155[0], fRec167[0]), std::max<float>(fRec179[0], fRec180[0]));
			...
			float fTemp573 = fRec151[1] + fConst323 * ((fTemp485 - fRec152[1]) / fTemp572);
			float fTemp574 = fConst323 * ((fConst323 / fTemp572 + 1.4285715f) / fTemp572) + 1.0f;
			float fTemp575 = fTemp573 / fTemp574;
			fRec151[0] = 2.0f * fTemp575 - fRec151[1];
			float fTemp576 = fTemp572 * fTemp574;
			float fTemp577 = fRec152[1] + fConst323 * (fTemp573 / fTemp576);
			...
			float fTemp580 = fTemp485 + fTemp579;
			float fTemp581 = fTemp571 + -1.0f;
			float fTemp582 = fRec153 * fTemp581;
			float fTemp583 = fTemp485 + 1.4285715f * fTemp582 + fTemp579;
			fRec187[0] = fConst327 * (fConst352 * fRec158[0] + fConst356 * fRec158[1] + fConst352 * fRec158[2]) - fConst326 * (fConst354 * fRec187[2] + fConst353 * fRec187[1]);
			fRec186[0] = fConst326 * (fConst352 * fRec187[0] + fConst356 * fRec187[1] + fConst352 * fRec187[2]) - fConst325 * (fConst355 * fRec186[2] + fConst353 * fRec186[1]);
			float fTemp584 = std::fabs(fConst325 * (fConst352 * fRec186[0] + fConst356 * fRec186[1] + fConst352 * fRec186[2]));
			fVec528[0] = fTemp584;
			float fTemp585 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp584));
			int iTemp586 = (fTemp585 > fSlow75) + (fTemp585 > fSlow76);
			float fTemp587 = 0.0f - fSlow74 * std::max<float>(0.0f, ((iTemp586 == 0) ? 0.0f : ((iTemp586 == 1) ? 0.083333336f * mydsp_faustpower2_f(fSlow19 + (fTemp585 + -3.0f - fSlow2)) : fSlow19 + (fTemp585 + -6.0f - fSlow2))));
			float fTemp588 = ((fTemp587 > fRec185[1]) ? fSlow83 : fSlow80);
			fRec185[0] = fTemp587 * (1.0f - fTemp588) + fRec185[1] * fTemp588;
			fRec190[0] = fConst327 * (fConst352 * fRec170[0] + fConst356 * fRec170[1] + fConst352 * fRec170[2]) - fConst326 * (fConst354 * fRec190[2] + fConst353 * fRec190[1]);
			fRec189[0] = fConst326 * (fConst352 * fRec190[0] + fConst356 * fRec190[1] + fConst352 * fRec190[2]) - fConst325 * (fConst355 * fRec189[2] + fConst353 * fRec189[1]);
			float fTemp589 = std::fabs(fConst325 * (fConst352 * fRec189[0] + fConst356 * fRec189[1] + fConst352 * fRec189[2]));
			fVec529[0] = fTemp589;
			float fTemp590 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp589));
			int iTemp591 = (fTemp590 > fSlow75) + (fTemp590 > fSlow76);
			float fTemp592 = 0.0f - fSlow74 * std::max<float>(0.0f, ((iTemp591 == 0) ? 0.0f : ((iTemp591 == 1) ? 0.083333336f * mydsp_faustpower2_f(fSlow19 + (fTemp590 + -3.0f - fSlow2)) : fSlow19 + (fTemp590 + -6.0f - fSlow2))));
			float fTemp593 = ((fTemp592 > fRec188[1]) ? fSlow83 : fSlow80);
			fRec188[0] = fTemp592 * (1.0f - fTemp593) + fRec188[1] * fTemp593;
			float fTemp594 = std::max<float>(fTemp584, fVec528[1]);
			fVec530[0] = fTemp594;
			float fTemp595 = std::max<float>(fTemp594, fVec530[2]);
			fVec531[0] = fTemp595;
			float fTemp596 = std::max<float>(fTemp595, fVec531[4]);
			fVec532[0] = fTemp596;
			float fTemp597 = std::max<float>(fTemp596, fVec532[8]);
			fVec533[IOTA0 & 31] = fTemp597;
			float fTemp598 = std::max<float>(fTemp597, fVec533[(IOTA0 - 16) & 31]);
			fVec534[IOTA0 & 63] = fTemp598;
			float fTemp599 = std::max<float>(fTemp598, fVec534[(IOTA0 - 32) & 63]);
			fVec535[IOTA0 & 127] = fTemp599;
			float fTemp600 = std::max<float>(fTemp599, fVec535[(IOTA0 - 64) & 127]);
			fVec536[IOTA0 & 255] = fTemp600;
			float fTemp601 = std::max<float>(fTemp600, fVec536[(IOTA0 - 128) & 255]);
			fVec537[IOTA0 & 511] = fTemp601;
			float fTemp602 = std::max<float>(fTemp601, fVec537[(IOTA0 - 256) & 511]);
			fVec538[IOTA0 & 1023] = fTemp602;
			float fTemp603 = std::max<float>(fTemp602, fVec538[(IOTA0 - 512) & 1023]);
			fVec539[IOTA0 & 2047] = fTemp603;
			fVec540[IOTA0 & 4095] = std::max<float>(fTemp603, fVec539[(IOTA0 - 1024) & 2047]);
			float fTemp604 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst301) ? fTemp584 : -3.4028235e+38f), ((iConst302) ? fVec530[iConst301] : -3.4028235e+38f)), ((iConst303) ? fVec531[iConst304] : -3.4028235e+38f)), ((iConst305) ? fVec532[iConst306] : -3.4028235e+38f)), ((iConst307) ? fVec533[(IOTA0 - iConst308) & 31] : -3.4028235e+38f)), ((iConst309) ? fVec534[(IOTA0 - iConst310) & 63] : -3.4028235e+38f)), ((iConst311) ? fVec535[(IOTA0 - iConst312) & 127] : -3.4028235e+38f)), ((iConst313) ? fVec536[(IOTA0 - iConst314) & 255] : -3.4028235e+38f)), ((iConst315) ? fVec537[(IOTA0 - iConst316) & 511] : -3.4028235e+38f)), ((iConst317) ? fVec538[(IOTA0 - iConst318) & 1023] : -3.4028235e+38f)), ((iConst319) ? fVec539[(IOTA0 - iConst320) & 2047] : -3.4028235e+38f)), ((iConst321) ? fVec540[(IOTA0 - iConst322) & 4095] : -3.4028235e+38f))));
			int iTemp605 = (fTemp604 > fSlow85) + (fTemp604 > fSlow87);
			float fTemp606 = fTemp604 + 4e+01f;
			float fTemp607 = std::max<float>(fSlow32, fSlow63 * ((iTemp605 == 0) ? fTemp606 - fSlow84 : ((iTemp605 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp606 - fSlow86) : 0.0f)));
			float fTemp608 = (((fSlow62 * fTemp607) > fRec191[1]) ? fSlow94 : fSlow91);
			fRec191[0] = fSlow62 * fTemp607 * (1.0f - fTemp608) + fRec191[1] * fTemp608;
			float fTemp609 = std::max<float>(fTemp589, fVec529[1]);
			fVec541[0] = fTemp609;
			float fTemp610 = std::max<float>(fTemp609, fVec541[2]);
			fVec542[0] = fTemp610;
			float fTemp611 = std::max<float>(fTemp610, fVec542[4]);
			fVec543[0] = fTemp611;
			float fTemp612 = std::max<float>(fTemp611, fVec543[8]);
			fVec544[IOTA0 & 31] = fTemp612;
			float fTemp613 = std::max<float>(fTemp612, fVec544[(IOTA0 - 16) & 31]);
			fVec545[IOTA0 & 63] = fTemp613;
			float fTemp614 = std::max<float>(fTemp613, fVec545[(IOTA0 - 32) & 63]);
			fVec546[IOTA0 & 127] = fTemp614;
			float fTemp615 = std::max<float>(fTemp614, fVec546[(IOTA0 - 64) & 127]);
			fVec547[IOTA0 & 255] = fTemp615;
			float fTemp616 = std::max<float>(fTemp615, fVec547[(IOTA0 - 128) & 255]);
			fVec548[IOTA0 & 511] = fTemp616;
			float fTemp617 = std::max<float>(fTemp616, fVec548[(IOTA0 - 256) & 511]);
			fVec549[IOTA0 & 1023] = fTemp617;
			float fTemp618 = std::max<float>(fTemp617, fVec549[(IOTA0 - 512) & 1023]);
			fVec550[IOTA0 & 2047] = fTemp618;
			fVec551[IOTA0 & 4095] = std::max<float>(fTemp618, fVec550[(IOTA0 - 1024) & 2047]);
			float fTemp619 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst301) ? fTemp589 : -3.4028235e+38f), ((iConst302) ? fVec541[iConst301] : -3.4028235e+38f)), ((iConst303) ? fVec542[iConst304] : -3.4028235e+38f)), ((iConst305) ? fVec543[iConst306] : -3.4028235e+38f)), ((iConst307) ? fVec544[(IOTA0 - iConst308) & 31] : -3.4028235e+38f)), ((iConst309) ? fVec545[(IOTA0 - iConst310) & 63] : -3.4028235e+38f)), ((iConst311) ? fVec546[(IOTA0 - iConst312) & 127] : -3.4028235e+38f)), ((iConst313) ? fVec547[(IOTA0 - iConst314) & 255] : -3.4028235e+38f)), ((iConst315) ? fVec548[(IOTA0 - iConst316) & 511] : -3.4028235e+38f)), ((iConst317) ? fVec549[(IOTA0 - iConst318) & 1023] : -3.4028235e+38f)), ((iConst319) ? fVec550[(IOTA0 - iConst320) & 2047] : -3.4028235e+38f)), ((iConst321) ? fVec551[(IOTA0 - iConst322) & 4095] : -3.4028235e+38f))));
			int iTemp620 = (fTemp619 > fSlow85) + (fTemp619 > fSlow87);
			float fTemp621 = fTemp619 + 4e+01f;
			float fTemp622 = std::max<float>(fSlow32, fSlow63 * ((iTemp620 == 0) ? fTemp621 - fSlow84 : ((iTemp620 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp621 - fSlow86) : 0.0f)));
			float fTemp623 = (((fSlow62 * fTemp622) > fRec192[1]) ? fSlow94 : fSlow91);
			fRec192[0] = fSlow62 * fTemp622 * (1.0f - fTemp623) + fRec192[1] * fTemp623;
			float fTemp624 = std::min<float>(fSlow16 + std::min<float>(fRec185[0], fRec188[0]), std::max<float>(fRec191[0], fRec192[0]));
			fVbargraph25 = FAUSTFLOAT(std::min<float>(12.0f, std::max<float>(-12.0f, fTemp624)));
			float fTemp625 = 0.025f * fTemp624;
			float fTemp626 = std::pow(1e+01f, 0.0f - fTemp625);
			float fTemp627 = std::sqrt(fTemp626);
			float fTemp628 = fRec181[1] + fConst323 * ((fTemp583 - fRec182[1]) / fTemp627);
			float fTemp629 = fConst323 * ((fConst323 / fTemp627 + 1.4285715f) / fTemp627) + 1.0f;
			float fTemp630 = fTemp628 / fTemp629;
			fRec181[0] = 2.0f * fTemp630 - fRec181[1];
			float fTemp631 = fTemp627 * fTemp629;
			float fTemp632 = fRec182[1] + fConst323 * (fTemp628 / fTemp631);
			fRec182[0] = 2.0f * fTemp632 - fRec182[1];
			float fRec183 = fTemp630;
			float fRec184 = fTemp632;
			float fTemp633 = mydsp_faustpower2_f(fTemp626) + -1.0f;
			float fTemp634 = fRec184 * fTemp633;
			float fTemp635 = fTemp580 + fTemp634;
			float fTemp636 = fTemp626 + -1.0f;
			float fTemp637 = fTemp582 + fRec183 * fTemp636;
			float fTemp638 = 1.4285715f * fTemp637 + fTemp580 + fTemp634;
			float fTemp639 = std::pow(1e+01f, fTemp625);
			float fTemp640 = std::sqrt(fTemp639);
			float fTemp641 = fRec193[1] + fConst328 * ((fTemp638 - fRec194[1]) / fTemp640);
			float fTemp642 = fConst328 * ((fConst328 / fTemp640 + 1.4285715f) / fTemp640) + 1.0f;
			float fTemp643 = fTemp641 / fTemp642;
			fRec193[0] = 2.0f * fTemp643 - fRec193[1];
			float fTemp644 = fTemp640 * fTemp642;
			float fTemp645 = fRec194[1] + fConst328 * (fTemp641 / fTemp644);
			fRec194[0] = 2.0f * fTemp645 - fRec194[1];
			float fRec195 = fTemp643;
			float fRec196 = fTemp645;
			float fTemp646 = mydsp_faustpower2_f(fTemp639) + -1.0f;
			float fTemp647 = fRec196 * fTemp646;
			float fTemp648 = fTemp635 + fTemp647;
			float fTemp649 = fTemp639 + -1.0f;
			float fTemp650 = fTemp637 + fRec195 * fTemp649;
			float fTemp651 = 1.4285715f * fTemp650 + fTemp635 + fTemp647;
			fRec203[0] = fConst332 * (fConst346 * fRec161[0] + fConst357 * fRec161[1] + fConst346 * fRec161[2]) - fConst331 * (fConst348 * fRec203[2] + fConst347 * fRec203[1]);
			fRec202[0] = fConst331 * (fConst346 * fRec203[0] + fConst357 * fRec203[1] + fConst346 * fRec203[2]) - fConst330 * (fConst349 * fRec202[2] + fConst347 * fRec202[1]);
			float fTemp652 = std::fabs(fConst330 * (fConst346 * fRec202[0] + fConst357 * fRec202[1] + fConst346 * fRec202[2]));
			fVec552[0] = fTemp652;
			float fTemp653 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp652));
			int iTemp654 = (fTemp653 > fSlow97) + (fTemp653 > fSlow98);
			float fTemp655 = 0.0f - fSlow96 * std::max<float>(0.0f, ((iTemp654 == 0) ? 0.0f : ((iTemp654 == 1) ? 0.071428575f * mydsp_faustpower2_f(fSlow19 + (fTemp653 + -0.5f - fSlow2)) : fSlow19 + (fTemp653 + -4.0f - fSlow2))));
			float fTemp656 = ((fTemp655 > fRec201[1]) ? fSlow104 : fSlow101);
			fRec201[0] = fTemp655 * (1.0f - fTemp656) + fRec201[1] * fTemp656;
			fRec206[0] = fConst332 * (fConst346 * fRec173[0] + fConst357 * fRec173[1] + fConst346 * fRec173[2]) - fConst331 * (fConst348 * fRec206[2] + fConst347 * fRec206[1]);
			fRec205[0] = fConst331 * (fConst346 * fRec206[0] + fConst357 * fRec206[1] + fConst346 * fRec206[2]) - fConst330 * (fConst349 * fRec205[2] + fConst347 * fRec205[1]);
			float fTemp657 = std::fabs(fConst330 * (fConst346 * fRec205[0] + fConst357 * fRec205[1] + fConst346 * fRec205[2]));
			fVec553[0] = fTemp657;
			float fTemp658 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp657));
			int iTemp659 = (fTemp658 > fSlow97) + (fTemp658 > fSlow98);
			float fTemp660 = 0.0f - fSlow96 * std::max<float>(0.0f, ((iTemp659 == 0) ? 0.0f : ((iTemp659 == 1) ? 0.071428575f * mydsp_faustpower2_f(fSlow19 + (fTemp658 + -0.5f - fSlow2)) : fSlow19 + (fTemp658 + -4.0f - fSlow2))));
			float fTemp661 = ((fTemp660 > fRec204[1]) ? fSlow104 : fSlow101);
			fRec204[0] = fTemp660 * (1.0f - fTemp661) + fRec204[1] * fTemp661;
			float fTemp662 = std::max<float>(fTemp652, fVec552[1]);
			fVec554[0] = fTemp662;
			float fTemp663 = std::max<float>(fTemp662, fVec554[2]);
			fVec555[0] = fTemp663;
			float fTemp664 = std::max<float>(fTemp663, fVec555[4]);
			fVec556[0] = fTemp664;
			float fTemp665 = std::max<float>(fTemp664, fVec556[8]);
			fVec557[IOTA0 & 31] = fTemp665;
			float fTemp666 = std::max<float>(fTemp665, fVec557[(IOTA0 - 16) & 31]);
			fVec558[IOTA0 & 63] = fTemp666;
			float fTemp667 = std::max<float>(fTemp666, fVec558[(IOTA0 - 32) & 63]);
			fVec559[IOTA0 & 127] = fTemp667;
			float fTemp668 = std::max<float>(fTemp667, fVec559[(IOTA0 - 64) & 127]);
			fVec560[IOTA0 & 255] = fTemp668;
			float fTemp669 = std::max<float>(fTemp668, fVec560[(IOTA0 - 128) & 255]);
			fVec561[IOTA0 & 511] = fTemp669;
			float fTemp670 = std::max<float>(fTemp669, fVec561[(IOTA0 - 256) & 511]);
			fVec562[IOTA0 & 1023] = fTemp670;
			float fTemp671 = std::max<float>(fTemp670, fVec562[(IOTA0 - 512) & 1023]);
			fVec563[IOTA0 & 2047] = fTemp671;
			fVec564[IOTA0 & 4095] = std::max<float>(fTemp671, fVec563[(IOTA0 - 1024) & 2047]);
			float fTemp672 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst301) ? fTemp652 : -3.4028235e+38f), ((iConst302) ? fVec554[iConst301] : -3.4028235e+38f)), ((iConst303) ? fVec555[iConst304] : -3.4028235e+38f)), ((iConst305) ? fVec556[iConst306] : -3.4028235e+38f)), ((iConst307) ? fVec557[(IOTA0 - iConst308) & 31] : -3.4028235e+38f)), ((iConst309) ? fVec558[(IOTA0 - iConst310) & 63] : -3.4028235e+38f)), ((iConst311) ? fVec559[(IOTA0 - iConst312) & 127] : -3.4028235e+38f)), ((iConst313) ? fVec560[(IOTA0 - iConst314) & 255] : -3.4028235e+38f)), ((iConst315) ? fVec561[(IOTA0 - iConst316) & 511] : -3.4028235e+38f)), ((iConst317) ? fVec562[(IOTA0 - iConst318) & 1023] : -3.4028235e+38f)), ((iConst319) ? fVec563[(IOTA0 - iConst320) & 2047] : -3.4028235e+38f)), ((iConst321) ? fVec564[(IOTA0 - iConst322) & 4095] : -3.4028235e+38f))));
			int iTemp673 = (fTemp672 > fSlow39) + (fTemp672 > fSlow42);
			float fTemp674 = fTemp672 + 4e+01f;
			float fTemp675 = std::max<float>(fSlow32, fSlow108 * ((iTemp673 == 0) ? fTemp674 - fSlow35 : ((iTemp673 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp674 - fSlow41) : 0.0f)));
			float fTemp676 = (((fSlow107 * fTemp675) > fRec207[1]) ? fSlow116 : fSlow113);
			fRec207[0] = fSlow107 * fTemp675 * (1.0f - fTemp676) + fRec207[1] * fTemp676;
			float fTemp677 = std::max<float>(fTemp657, fVec553[1]);
			fVec565[0] = fTemp677;
			float fTemp678 = std::max<float>(fTemp677, fVec565[2]);
			fVec566[0] = fTemp678;
			float fTemp679 = std::max<float>(fTemp678, fVec566[4]);
			fVec567[0] = fTemp679;
			float fTemp680 = std::max<float>(fTemp679, fVec567[8]);
			fVec568[IOTA0 & 31] = fTemp680;
			float fTemp681 = std::max<float>(fTemp680, fVec568[(IOTA0 - 16) & 31]);
			fVec569[IOTA0 & 63] = fTemp681;
			float fTemp682 = std::max<float>(fTemp681, fVec569[(IOTA0 - 32) & 63]);
			fVec570[IOTA0 & 127] = fTemp682;
			float fTemp683 = std::max<float>(fTemp682, fVec570[(IOTA0 - 64) & 127]);
			fVec571[IOTA0 & 255] = fTemp683;
			float fTemp684 = std::max<float>(fTemp683, fVec571[(IOTA0 - 128) & 255]);
			fVec572[IOTA0 & 511] = fTemp684;
			float fTemp685 = std::max<float>(fTemp684, fVec572[(IOTA0 - 256) & 511]);
			fVec573[IOTA0 & 1023] = fTemp685;
			float fTemp686 = std::max<float>(fTemp685, fVec573[(IOTA0 - 512) & 1023]);
			fVec574[IOTA0 & 2047] = fTemp686;
			fVec575[IOTA0 & 4095] = std::max<float>(fTemp686, fVec574[(IOTA0 - 1024) & 2047]);
			float fTemp687 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst301) ? fTemp657 : -3.4028235e+38f), ((iConst302) ? fVec565[iConst301] : -3.4028235e+38f)), ((iConst303) ? fVec566[iConst304] : -3.4028235e+38f)), ((iConst305) ? fVec567[iConst306] : -3.4028235e+38f)), ((iConst307) ? fVec568[(IOTA0 - iConst308) & 31] : -3.4028235e+38f)), ((iConst309) ? fVec569[(IOTA0 - iConst310) & 63] : -3.4028235e+38f)), ((iConst311) ? fVec570[(IOTA0 - iConst312) & 127] : -3.4028235e+38f)), ((iConst313) ? fVec571[(IOTA0 - iConst314) & 255] : -3.4028235e+38f)), ((iConst315) ? fVec572[(IOTA0 - iConst316) & 511] : -3.4028235e+38f)), ((iConst317) ? fVec573[(IOTA0 - iConst318) & 1023] : -3.4028235e+38f)), ((iConst319) ? fVec574[(IOTA0 - iConst320) & 2047] : -3.4028235e+38f)), ((iConst321) ? fVec575[(IOTA0 - iConst322) & 4095] : -3.4028235e+38f))));
			int iTemp688 = (fTemp687 > fSlow39) + (fTemp687 > fSlow42);
			float fTemp689 = fTemp687 + 4e+01f;
			float fTemp690 = std::max<float>(fSlow32, fSlow108 * ((iTemp688 == 0) ? fTemp689 - fSlow35 : ((iTemp688 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp689 - fSlow41) : 0.0f)));
			float fTemp691 = (((fSlow107 * fTemp690) > fRec208[1]) ? fSlow116 : fSlow113);
			fRec208[0] = fSlow107 * fTemp690 * (1.0f - fTemp691) + fRec208[1] * fTemp691;
			float fTemp692 = std::min<float>(fSlow16 + std::min<float>(fRec201[0], fRec204[0]), std::max<float>(fRec207[0], fRec208[0]));
			fVbargraph26 = FAUSTFLOAT(std::min<float>(12.0f, std::max<float>(-12.0f, fTemp692)));
			float fTemp693 = 0.025f * fTemp692;
			float fTemp694 = std::pow(1e+01f, 0.0f - fTemp693);
			float fTemp695 = std::sqrt(fTemp694);
			float fTemp696 = fRec197[1] + fConst328 * ((fTemp651 - fRec198[1]) / fTemp695);
			float fTemp697 = fConst328 * ((fConst328 / fTemp695 + 1.4285715f) / fTemp695) + 1.0f;
			float fTemp698 = fTemp696 / fTemp697;
			fRec197[0] = 2.0f * fTemp698 - fRec197[1];
			float fTemp699 = fTemp695 * fTemp697;
			float fTemp700 = fRec198[1] + fConst328 * (fTemp696 / fTemp699);
			fRec198[0] = 2.0f * fTemp700 - fRec198[1];
			float fRec199 = fTemp698;
			float fRec200 = fTemp700;
			float fTemp701 = mydsp_faustpower2_f(fTemp694) + -1.0f;
			float fTemp702 = fRec200 * fTemp701;
			float fTemp703 = fTemp648 + fTemp702;
			float fTemp704 = fTemp694 + -1.0f;
			float fTemp705 = fTemp650 + fRec199 * fTemp704;
			float fTemp706 = 1.4285715f * fTemp705 + fTemp648 + fTemp702;
			float fTemp707 = std::pow(1e+01f, fTemp693);
			float fTemp708 = std::sqrt(fTemp707);
			float fTemp709 = fRec209[1] + fConst333 * ((fTemp706 - fRec210[1]) / fTemp708);
			float fTemp710 = fConst333 * ((fConst333 / fTemp708 + 1.4285715f) / fTemp708) + 1.0f;
			float fTemp711 = fTemp709 / fTemp710;
			fRec209[0] = 2.0f * fTemp711 - fRec209[1];
			float fTemp712 = fTemp708 * fTemp710;
			float fTemp713 = fRec210[1] + fConst333 * (fTemp709 / fTemp712);
			fRec210[0] = 2.0f * fTemp713 - fRec210[1];
			float fRec211 = fTemp711;
			float fRec212 = fTemp713;
			float fTemp714 = mydsp_faustpower2_f(fTemp707) + -1.0f;
			float fTemp715 = fRec212 * fTemp714;
			float fTemp716 = fTemp707 + -1.0f;
			float fTemp717 = fTemp705 + fRec211 * fTemp716;
			float fTemp718 = 1.4285715f * fTemp717 + fTemp703 + fTemp715;
			fRec219[0] = fConst337 * (fConst340 * fRec164[0] + fConst358 * fRec164[1] + fConst340 * fRec164[2]) - fConst336 * (fConst342 * fRec219[2] + fConst341 * fRec219[1]);
			fRec218[0] = fConst336 * (fConst340 * fRec219[0] + fConst358 * fRec219[1] + fConst340 * fRec219[2]) - fConst335 * (fConst343 * fRec218[2] + fConst341 * fRec218[1]);
			float fTemp719 = std::fabs(fConst335 * (fConst340 * fRec218[0] + fConst358 * fRec218[1] + fConst340 * fRec218[2]));
			fVec576[0] = fTemp719;
			float fTemp720 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp719));
			int iTemp721 = (fTemp720 > fSlow119) + (fTemp720 > fSlow120);
			float fTemp722 = 0.0f - fSlow117 * std::max<float>(0.0f, ((iTemp721 == 0) ? 0.0f : ((iTemp721 == 1) ? 0.0625f * mydsp_faustpower2_f(fTemp720 + 4.0f - fSlow118) : fTemp720 - fSlow118)));
			float fTemp723 = ((fTemp722 > fRec217[1]) ? fSlow126 : fSlow123);
			fRec217[0] = fTemp722 * (1.0f - fTemp723) + fRec217[1] * fTemp723;
			fRec222[0] = fConst337 * (fConst340 * fRec176[0] + fConst358 * fRec176[1] + fConst340 * fRec176[2]) - fConst336 * (fConst342 * fRec222[2] + fConst341 * fRec222[1]);
			fRec221[0] = fConst336 * (fConst340 * fRec222[0] + fConst358 * fRec222[1] + fConst340 * fRec222[2]) - fConst335 * (fConst343 * fRec221[2] + fConst341 * fRec221[1]);
			float fTemp724 = std::fabs(fConst335 * (fConst340 * fRec221[0] + fConst358 * fRec221[1] + fConst340 * fRec221[2]));
			fVec577[0] = fTemp724;
			float fTemp725 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp724));
			int iTemp726 = (fTemp725 > fSlow119) + (fTemp725 > fSlow120);
			float fTemp727 = 0.0f - fSlow117 * std::max<float>(0.0f, ((iTemp726 == 0) ? 0.0f : ((iTemp726 == 1) ? 0.0625f * mydsp_faustpower2_f(fTemp725 + 4.0f - fSlow118) : fTemp725 - fSlow118)));
			float fTemp728 = ((fTemp727 > fRec220[1]) ? fSlow126 : fSlow123);
			...
			float fTemp754 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(std::max<float>(((iConst301) ? fTemp724 : -3.4028235e+38f), ((iConst302) ? fVec589[iConst301] : -3.4028235e+38f)), ((iConst303) ? fVec590[iConst304] : -3.4028235e+38f)), ((iConst305) ? fVec591[iConst306] : -3.4028235e+38f)), ((iConst307) ? fVec592[(IOTA0 - iConst308) & 31] : -3.4028235e+38f)), ((iConst309) ? fVec593[(IOTA0 - iConst310) & 63] : -3.4028235e+38f)), ((iConst311) ? fVec594[(IOTA0 - iConst312) & 127] : -3.4028235e+38f)), ((iConst313) ? fVec595[(IOTA0 - iConst314) & 255] : -3.4028235e+38f)), ((iConst315) ? fVec596[(IOTA0 - iConst316) & 511] : -3.4028235e+38f)), ((iConst317) ? fVec597[(IOTA0 - iConst318) & 1023] : -3.4028235e+38f)), ((iConst319) ? fVec598[(IOTA0 - iConst320) & 2047] : -3.4028235e+38f)), ((iConst321) ? fVec599[(IOTA0 - iConst322) & 4095] : -3.4028235e+38f))));
			int iTemp755 = (fTemp754 > fSlow39) + (fTemp754 > fSlow42);
			float fTemp756 = fTemp754 + 4e+01f;
			float fTemp757 = std::max<float>(fSlow32, fSlow130 * ((iTemp755 == 0) ? fTemp756 - fSlow35 : ((iTemp755 == 1) ? fSlow43 * mydsp_faustpower2_f(fTemp756 - fSlow41) : 0.0f)));
			float fTemp758 = (((fSlow129 * fTemp757) > fRec224[1]) ? fSlow137 : fSlow134);
			fRec224[0] = fSlow129 * fTemp757 * (1.0f - fTemp758) + fRec224[1] * fTemp758;
			float fTemp759 = std::min<float>(fSlow16 + std::min<float>(fRec217[0], fRec220[0]), std::max<float>(fRec223[0], fRec224[0]));
			...
			float fTemp763 = fRec213[1] + fConst333 * ((fTemp718 - fRec214[1]) / fTemp762);
			float fTemp764 = fConst333 * ((fConst333 / fTemp762 + 1.4285715f) / fTemp762) + 1.0f;
			float fTemp765 = fTemp763 / fTemp764;
			fRec213[0] = 2.0f * fTemp765 - fRec213[1];
			float fTemp766 = fTemp762 * fTemp764;
			float fTemp767 = fRec214[1] + fConst333 * (fTemp763 / fTemp766);
			fRec214[0] = 2.0f * fTemp767 - fRec214[1];
			float fRec215 = fTemp765;
			float fRec216 = fTemp767;
			float fTemp768 = mydsp_faustpower2_f(fTemp761) + -1.0f;
			float fTemp769 = fTemp703 + fTemp715 + fRec216 * fTemp768;
			float fTemp770 = fTemp761 + -1.0f;
			float fTemp771 = fTemp717 + fRec215 * fTemp770;
			float fTemp772 = 1.4285715f * fTemp771 + fTemp769;
			float fTemp773 = std::pow(1e+01f, fTemp760);
			float fTemp774 = std::sqrt(fTemp773);
			float fTemp775 = fRec225[1] + fConst288 * ((fTemp772 - fRec226[1]) / fTemp774);
			float fTemp776 = fConst288 * ((fConst288 / fTemp774 + 1.4285715f) / fTemp774) + 1.0f;
			float fTemp777 = fTemp775 / fTemp776;
			fRec225[0] = 2.0f * fTemp777 - fRec225[1];
			float fTemp778 = fTemp774 * fTemp776;
			float fTemp779 = fRec226[1] + fConst288 * (fTemp775 / fTemp778);
			fRec226[0] = 2.0f * fTemp779 - fRec226[1];
			float fRec227 = fTemp777;
			float fRec228 = fTemp779;
			float fTemp780 = fTemp773 + -1.0f;
			float fTemp781 = mydsp_faustpower2_f(fTemp773) + -1.0f;
			float fTemp782 = fTemp769 + 1.4285715f * (fTemp771 + fRec227 * fTemp780) + fRec228 * fTemp781;
			float fTemp783 = std::sqrt(fTemp529);
			float fTemp784 = fRec229[1] + fConst288 * fTemp783 * (fTemp782 - fRec230[1]);
			float fTemp785 = fConst288 * fTemp783 * (fConst288 * fTemp783 + 1.4285715f) + 1.0f;
			float fTemp786 = fTemp784 / fTemp785;
			fRec229[0] = 2.0f * fTemp786 - fRec229[1];
			float fTemp787 = fRec230[1] + fConst288 * (fTemp783 * fTemp784 / fTemp785);
			fRec230[0] = 2.0f * fTemp787 - fRec230[1];
			float fRec231 = fTemp786;
			float fRec232 = fTemp787;
			float fTemp788 = 1.0f - fTemp529;
			float fTemp789 = 1.0f - mydsp_faustpower2_f(fTemp529);
			float fTemp790 = fRec7[0] * fTemp485 + fTemp486 * (fTemp529 * (fTemp529 * fTemp782 + 1.4285715f * fRec231 * fTemp788) + fRec232 * fTemp789);
			fVec600[IOTA0 & 2047] = fTemp790;
			float fTemp791 = fRec233[1] + fConst323 * ((fTemp492 - fRec234[1]) / fTemp572);
			float fTemp792 = fTemp791 / fTemp574;
			fRec233[0] = 2.0f * fTemp792 - fRec233[1];
			float fTemp793 = fRec234[1] + fConst323 * (fTemp791 / fTemp576);
			fRec234[0] = 2.0f * fTemp793 - fRec234[1];
			float fRec235 = fTemp792;
			float fRec236 = fTemp793;
			float fTemp794 = fRec235 * fTemp581;
			float fTemp795 = fRec236 * fTemp578;
			float fTemp796 = fTemp492 + 1.4285715f * fTemp794 + fTemp795;
			float fTemp797 = fRec237[1] + fConst323 * ((fTemp796 - fRec238[1]) / fTemp627);
			float fTemp798 = fTemp797 / fTemp629;
			fRec237[0] = 2.0f * fTemp798 - fRec237[1];
			float fTemp799 = fRec238[1] + fConst323 * (fTemp797 / fTemp631);
			fRec238[0] = 2.0f * fTemp799 - fRec238[1];
			float fRec239 = fTemp798;
			float fRec240 = fTemp799;
			float fTemp800 = fTemp794 + fRec239 * fTemp636;
			float fTemp801 = fTemp492 + fTemp795;
			float fTemp802 = fRec240 * fTemp633;
			float fTemp803 = 1.4285715f * fTemp800 + fTemp801 + fTemp802;
			float fTemp804 = fRec241[1] + fConst328 * ((fTemp803 - fRec242[1]) / fTemp640);
			float fTemp805 = fTemp804 / fTemp642;
			fRec241[0] = 2.0f * fTemp805 - fRec241[1];
			float fTemp806 = fRec242[1] + fConst328 * (fTemp804 / fTemp644);
			fRec242[0] = 2.0f * fTemp806 - fRec242[1];
			float fRec243 = fTemp805;
			float fRec244 = fTemp806;
			float fTemp807 = fTemp800 + fRec243 * fTemp649;
			float fTemp808 = fTemp801 + fTemp802;
			float fTemp809 = fRec244 * fTemp646;
			float fTemp810 = 1.4285715f * fTemp807 + fTemp808 + fTemp809;
			float fTemp811 = fRec245[1] + fConst328 * ((fTemp810 - fRec246[1]) / fTemp695);
			float fTemp812 = fTemp811 / fTemp697;
			fRec245[0] = 2.0f * fTemp812 - fRec245[1];
			float fTemp813 = fRec246[1] + fConst328 * (fTemp811 / fTemp699);
			fRec246[0] = 2.0f * fTemp813 - fRec246[1];
			float fRec247 = fTemp812;
			float fRec248 = fTemp813;
			float fTemp814 = fTemp807 + fRec247 * fTemp704;
			float fTemp815 = fTemp808 + fTemp809;
			float fTemp816 = fRec248 * fTemp701;
			float fTemp817 = 1.4285715f * fTemp814 + fTemp815 + fTemp816;
			float fTemp818 = fRec249[1] + fConst333 * ((fTemp817 - fRec250[1]) / fTemp708);
			float fTemp819 = fTemp818 / fTemp710;
			fRec249[0] = 2.0f * fTemp819 - fRec249[1];
			float fTemp820 = fRec250[1] + fConst333 * (fTemp818 / fTemp712);
			fRec250[0] = 2.0f * fTemp820 - fRec250[1];
			float fRec251 = fTemp819;
			float fRec252 = fTemp820;
			float fTemp821 = fTemp814 + fRec251 * fTemp716;
			float fTemp822 = fTemp815 + fTemp816;
			float fTemp823 = fRec252 * fTemp714;
			float fTemp824 = 1.4285715f * fTemp821 + fTemp822 + fTemp823;
			float fTemp825 = fRec253[1] + fConst333 * ((fTemp824 - fRec254[1]) / fTemp762);
			float fTemp826 = fTemp825 / fTemp764;
			fRec253[0] = 2.0f * fTemp826 - fRec253[1];
			float fTemp827 = fRec254[1] + fConst333 * (fTemp825 / fTemp766);
			fRec254[0] = 2.0f * fTemp827 - fRec254[1];
			float fRec255 = fTemp826;
			float fRec256 = fTemp827;
			float fTemp828 = fTemp821 + fRec255 * fTemp770;
			float fTemp829 = fTemp822 + fTemp823;
			float fTemp830 = fRec256 * fTemp768;
			float fTemp831 = 1.4285715f * fTemp828 + fTemp829 + fTemp830;
			float fTemp832 = fRec257[1] + fConst288 * ((fTemp831 - fRec258[1]) / fTemp774);
			float fTemp833 = fTemp832 / fTemp776;
			fRec257[0] = 2.0f * fTemp833 - fRec257[1];
			float fTemp834 = fRec258[1] + fConst288 * (fTemp832 / fTemp778);
			fRec258[0] = 2.0f * fTemp834 - fRec258[1];
			float fRec259 = fTemp833;
			float fRec260 = fTemp834;
			float fTemp835 = 1.4285715f * (fTemp828 + fRec259 * fTemp780) + fTemp829 + fTemp830 + fRec260 * fTemp781;
			float fTemp836 = fRec261[1] + fConst288 * fTemp783 * (fTemp835 - fRec262[1]);
			float fTemp837 = fTemp836 / fTemp785;
			fRec261[0] = 2.0f * fTemp837 - fRec261[1];
			float fTemp838 = fRec262[1] + fConst288 * (fTemp783 * fTemp836 / fTemp785);
			fRec262[0] = 2.0f * fTemp838 - fRec262[1];
			float fRec263 = fTemp837;
			float fRec264 = fTemp838;
			float fTemp839 = fRec7[0] * fTemp492 + fTemp486 * (fTemp529 * (fTemp529 * fTemp835 + 1.4285715f * fRec263 * fTemp788) + fRec264 * fTemp789);
			fVec601[IOTA0 & 2047] = fTemp839;
			float fTemp840 = std::fabs(std::max<float>(std::fabs(fTemp790), std::fabs(fTemp839)));
			int iTemp841 = (fTemp840 >= fRec6[1]) | (float(iRec5[1]) >= fConst18);
			iRec5[0] = ((iTemp841) ? 0 : iRec5[1] + 1);
			fRec6[0] = ((iTemp841) ? fTemp840 : fRec6[1]);
			fRec4[0] = fConst5 * fRec6[0] + fConst4 * fRec4[1];
			float fTemp842 = std::fabs(fRec4[0]);
			fRec3[0] = std::max<float>(fTemp842, fConst16 * fRec3[1] + fConst359 * fTemp842);
			float fTemp843 = std::min<float>(1.0f, 0.8912509f / std::max<float>(fRec3[0], 1.1920929e-07f));
			fVbargraph28 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fTemp843))));
			float fTemp844 = fTemp843 * (1.0f - fRec2[0]);
			float fTemp845 = fTemp1 * fRec2[0] + fTemp844 * fVec600[(IOTA0 - iConst360) & 2047];
			fRec0[0] = std::max<float>(fRec0[1] - fConst1, std::min<float>(1e+01f, 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(0.00031622776f, std::fabs(fTemp845))))));
			...
			fRec268[0] = fVec603[1] + fConst30 * (fConst34 * fTemp846 - 2.0f * (fConst35 * fRec268[1] - fConst36 * fVec602[1]));
			fRec267[0] = fRec268[0];
			...
			fVec605[0] = fTemp847;
			float fTemp848 = fTemp847 + fVec605[1];
			fVec606[0] = fTemp848;
			float fTemp849 = fTemp848 + fVec606[2];
			fVec607[0] = fTemp849;
			float fTemp850 = fTemp849 + fVec607[4];
			fVec608[0] = fTemp850;
			float fTemp851 = fTemp850 + fVec608[8];
			fVec609[IOTA0 & 31] = fTemp851;
			float fTemp852 = fTemp851 + fVec609[(IOTA0 - 16) & 31];
			fVec610[IOTA0 & 63] = fTemp852;
			float fTemp853 = fTemp852 + fVec610[(IOTA0 - 32) & 63];
			fVec611[IOTA0 & 127] = fTemp853;
			float fTemp854 = fTemp853 + fVec611[(IOTA0 - 64) & 127];
			fVec612[IOTA0 & 255] = fTemp854;
			float fTemp855 = fTemp854 + fVec612[(IOTA0 - 128) & 255];
			fVec613[IOTA0 & 511] = fTemp855;
			float fTemp856 = fTemp855 + fVec613[(IOTA0 - 256) & 511];
			fVec614[IOTA0 & 1023] = fTemp856;
			float fTemp857 = fTemp856 + fVec614[(IOTA0 - 512) & 1023];
			fVec615[IOTA0 & 2047] = fTemp857;
			float fTemp858 = fTemp857 + fVec615[(IOTA0 - 1024) & 2047];
			fVec616[IOTA0 & 4095] = fTemp858;
			float fTemp859 = fTemp858 + fVec616[(IOTA0 - 2048) & 4095];
			fVec617[IOTA0 & 8191] = fTemp859;
			float fTemp860 = fTemp859 + fVec617[(IOTA0 - 4096) & 8191];
			fVec618[IOTA0 & 16383] = fTemp860;
			float fTemp861 = fTemp860 + fVec618[(IOTA0 - 8192) & 16383];
			fVec619[IOTA0 & 32767] = fTemp861;
			float fTemp862 = fTemp861 + fVec619[(IOTA0 - 16384) & 32767];
			fVec620[IOTA0 & 65535] = fTemp862;
			fVec621[IOTA0 & 131071] = fTemp862 + fVec620[(IOTA0 - 32768) & 65535];
			float fTemp863 = fRec2[0] * fTemp44 + fTemp844 * fVec601[(IOTA0 - iConst360) & 2047];
			fRec273[0] = std::max<float>(fRec273[1] - fConst1, std::min<float>(1e+01f, 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(0.00031622776f, std::fabs(fTemp863))))));
			fVbargraph31 = FAUSTFLOAT(fRec273[0]);
			float fTemp864 = fTemp863;
			fVec622[0] = fTemp864;
			fVec623[0] = 0.0f - fConst30 * (fConst31 * fRec271[1] - fConst33 * fVec622[1]);
			fRec272[0] = fVec623[1] + fConst30 * (fConst34 * fTemp864 - 2.0f * (fConst35 * fRec272[1] - fConst36 * fVec622[1]));
			fRec271[0] = fRec272[0];
