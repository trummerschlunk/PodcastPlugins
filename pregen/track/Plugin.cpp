...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmpg2w255vo.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp653 = (fTemp652 > fSlow99) + (fTemp652 > fSlow100);
			float fTemp654 = 0.0f - fSlow98 * std::max<float>(0.0f, ((iTemp653 == 0) ? 0.0f : ((iTemp653 == 1) ? 0.071428575f * mydsp_faustpower2_f(fSlow22 + (fTemp652 + -0.5f - fSlow2)) : fSlow22 + (fTemp652 + -4.0f - fSlow2))));
			float fTemp655 = ((fTemp654 > fRec201[1]) ? fSlow106 : fSlow103);
			...
			int iTemp658 = (fTemp657 > fSlow99) + (fTemp657 > fSlow100);
			float fTemp659 = 0.0f - fSlow98 * std::max<float>(0.0f, ((iTemp658 == 0) ? 0.0f : ((iTemp658 == 1) ? 0.071428575f * mydsp_faustpower2_f(fSlow22 + (fTemp657 + -0.5f - fSlow2)) : fSlow22 + (fTemp657 + -4.0f - fSlow2))));
			float fTemp660 = ((fTemp659 > fRec204[1]) ? fSlow106 : fSlow103);
			...
			int iTemp672 = (fTemp671 > fSlow38) + (fTemp671 > fSlow40);
			float fTemp673 = fTemp671 + 4e+01f;
			float fTemp674 = std::max<float>(fSlow35, fSlow110 * ((iTemp672 == 0) ? fTemp673 - fSlow42 : ((iTemp672 == 1) ? fSlow41 * mydsp_faustpower2_f(fTemp673 - fSlow39) : 0.0f)));
			float fTemp675 = (((fSlow109 * fTemp674) > fRec207[1]) ? fSlow118 : fSlow115);
			fRec207[0] = fSlow109 * fTemp674 * (1.0f - fTemp675) + fRec207[1] * fTemp675;
			...
			int iTemp687 = (fTemp686 > fSlow38) + (fTemp686 > fSlow40);
			float fTemp688 = fTemp686 + 4e+01f;
			float fTemp689 = std::max<float>(fSlow35, fSlow110 * ((iTemp687 == 0) ? fTemp688 - fSlow42 : ((iTemp687 == 1) ? fSlow41 * mydsp_faustpower2_f(fTemp688 - fSlow39) : 0.0f)));
			float fTemp690 = (((fSlow109 * fTemp689) > fRec208[1]) ? fSlow118 : fSlow115);
			fRec208[0] = fSlow109 * fTemp689 * (1.0f - fTemp690) + fRec208[1] * fTemp690;
			float fTemp691 = std::min<float>(fSlow19 + std::min<float>(fRec201[0], fRec204[0]), std::max<float>(fRec207[0], fRec208[0]));
			...
			int iTemp721 = (fTemp720 > fSlow120) + (fTemp720 > fSlow121);
			float fTemp722 = 0.0f - fSlow119 * std::max<float>(0.0f, ((iTemp721 == 0) ? 0.0f : ((iTemp721 == 1) ? 0.0625f * mydsp_faustpower2_f(fSlow22 + (fTemp720 + 2.0f - fSlow2)) : fSlow22 + (fTemp720 + -2.0f - fSlow2))));
			float fTemp723 = ((fTemp722 > fRec217[1]) ? fSlow127 : fSlow124);
			...
			int iTemp726 = (fTemp725 > fSlow120) + (fTemp725 > fSlow121);
			float fTemp727 = 0.0f - fSlow119 * std::max<float>(0.0f, ((iTemp726 == 0) ? 0.0f : ((iTemp726 == 1) ? 0.0625f * mydsp_faustpower2_f(fSlow22 + (fTemp725 + 2.0f - fSlow2)) : fSlow22 + (fTemp725 + -2.0f - fSlow2))));
			float fTemp728 = ((fTemp727 > fRec220[1]) ? fSlow127 : fSlow124);
			...
			int iTemp740 = (fTemp739 > fSlow38) + (fTemp739 > fSlow40);
			float fTemp741 = fTemp739 + 4e+01f;
			float fTemp742 = std::max<float>(fSlow35, fSlow131 * ((iTemp740 == 0) ? fTemp741 - fSlow42 : ((iTemp740 == 1) ? fSlow41 * mydsp_faustpower2_f(fTemp741 - fSlow39) : 0.0f)));
			float fTemp743 = (((fSlow130 * fTemp742) > fRec223[1]) ? fSlow138 : fSlow135);
			fRec223[0] = fSlow130 * fTemp742 * (1.0f - fTemp743) + fRec223[1] * fTemp743;
			...
			int iTemp755 = (fTemp754 > fSlow38) + (fTemp754 > fSlow40);
			float fTemp756 = fTemp754 + 4e+01f;
			float fTemp757 = std::max<float>(fSlow35, fSlow131 * ((iTemp755 == 0) ? fTemp756 - fSlow42 : ((iTemp755 == 1) ? fSlow41 * mydsp_faustpower2_f(fTemp756 - fSlow39) : 0.0f)));
			float fTemp758 = (((fSlow130 * fTemp757) > fRec224[1]) ? fSlow138 : fSlow135);
			fRec224[0] = fSlow130 * fTemp757 * (1.0f - fTemp758) + fRec224[1] * fTemp758;
			float fTemp759 = std::min<float>(fSlow19 + std::min<float>(fRec217[0], fRec220[0]), std::max<float>(fRec223[0], fRec224[0]));
